 ...
 */
class MypaperController extends CControl {
	...
	*/
	public function all() {
        ...
        $this->display('college/mypaper_all');
		$this->_updateuserstate();
	}
	/**
	* 我做过的作业
	*/
	public function my() {
		...
		$this->assign('roominfo',$roominfo);
		$this->assign('pagestr',$pagestr);
        $this->display('college/mypaper_my');
	}
	/**
	* 我的作业草稿箱
	*/
	public function box() {
		...
		$this->assign('roominfo',$roominfo);
		$this->assign('pagestr',$pagestr);
        $this->display('college/mypaper_box');
	}
	/**
	*更新新作业用户状态时间
	*/
