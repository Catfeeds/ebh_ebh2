...
class StudentController extends CControl {
    ...
    public function check() {
        ...
        if($applys === NULL) { //显示
            ...
            $this->assign('pagestr', $pagestr);
            $this->assign('q', $q);
            $this->display('troom/student_check');
        } else {    //提交表单处理
    ...
    public function opencount() {
        ...
        $this->assign('pagestr', $pagestr);
        $this->display('troom/student_opencount');
    }
    ...
    public function add() {
        ...
        if ($username === NULL) {
            $this->display('troom/student_add');
        } else {  //提交表单
            $result = FALSE;
            $usermodel = $this->model('User');
    ...
    public function view() {
        ...
        $this->display('troom/student_view');
    }
