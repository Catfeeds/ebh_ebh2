...
class SubjectController extends CControl {
    ...
    public function add() {
        if ($this->input->post()) {
            ...
            header('location:' . geturl('troom/subject'));
        } else {
            $roominfo = Ebh::app()->room->getcurroom();
            $folder = $this->model('folder');
            $param['crid'] = $roominfo['crid'];
            ...
            $this->display('troom/subject_add');
        }
    }
    /**
     * 获取课程封面列表数组（此方法需改）
    ...
    public function img() {
        $this->display('troom/uploadimage');
    }
    /**
     * 编辑详情
     */
    public function edit_view() {
        ...
        $this->display('troom/subject_edit');
    }
    /*
     * 处理编辑表单提交
     */
    ...
    public function view() {
        ...
        $this->display('troom/subject_view');
    }
	...
	*/
	public function freecourseware(){
		...
		$this->assign('pagestr',$pagestr);
		$this->display('troom/freecourseware');
	}
