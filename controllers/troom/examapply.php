...
class ExamapplyController extends CControl {
	...
	public function index() {
		$this->display('troom/examapply_index');
	}
	...
	public function applylist() {
		...
		$this->display('troom/examapply_applylist');
	}
	...
	public function passapply() {
		...
		$this->assign('q',$queryarr['q']);
		$this->assign('pagestr', $pagestr);
		$this->display('troom/examapply_passapply');
	}
	...
	public function unpassapply() {
		...
		$this->assign('q',$queryarr['q']);
		$this->assign('pagestr', $pagestr);
		$this->display('troom/examapply_unpassapply');
	}
	...
	public function resultlist(){
		...
		$this->display('troom/examapply_resultlist');
	}
	...
	public function result_view(){
		...
		$this->assign('q',$param['q']);
		$this->display('troom/examapply_resultview');
	}
	...
	public function resultfail_view(){
		...
		$this->assign('exam',$exam);
		$this->assign('q',$param['q']);
		$this->display('troom/examapply_resultfailview');
	}
	...
	public function resultaward_view(){
		...
		$this->assign('exam',$exam);
		$this->assign('q',$param['q']);
		$this->display('troom/examapply_resultawardview');
	}
