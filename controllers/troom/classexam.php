...
class ClassexamController extends CControl {
	...
	*/
	public function cor(){
        ...
        $this->display('troom/classexam_cor');
	...
	*/
	public function my() {
		...
		if(is_numeric($classid) && $classid > 0) {
			...
			$this->display('troom/classexam_my');
		}
	}
	/**
	*班级作业对应的作业批阅
	*/
	public function all() {
		...
		$this->assign('roominfo',$roominfo);
		$this->assign('myclass',$myclass);
		$this->display('troom/classexam_all');
	}
...
/**
	...
	*/
	public function todayexams() {
		...
		$this->assign('myclass',$myclass);
		$this->assign('d',$d);
		$this->display('troom/classexam_today');
	}
