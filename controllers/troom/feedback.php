...
class FeedbackController extends CControl{
	...
	public function courses() {
        ...
        $this->display('troom/feedback_course');
    }
	...
	public function view(){
        ...
        $this->display('troom/feedback_courseware');
	}
	...
	public function courses_view(){
		...
		if(!empty($fblist)){
			...
			$this->display('troom/feedback_view');
		}
	}
