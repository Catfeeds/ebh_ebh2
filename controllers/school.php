 ...
 *新闻动态控制器
 */
class SchoolController extends PortalControl{
	...
	private function _home(){
		...
		$this->getAds($this->cateInfo['catid'],'nav',3);
		...
		//=====
		$this->_assignAll();
		$this->display('portal/home_school');
