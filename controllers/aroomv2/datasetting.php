...
class DatasettingController extends CControl {
	...
	*/
	public function index() {
		...
		$this->display('aroomv2/datasetting_announcement');
	}
	/**
	*删除公告
	*/
	...
	*/
	public function announcement_add() {
		...
		if(NULL !== $message) {	//处理表单
			...
			$this->display('aroomv2/datasetting_announcement_add');
		}
	}
	/**
	*修改公告
	*/
		...
		if(NULL !== $infoid) {	//处理表单提交
			...
			if(is_numeric($infoid) && $infoid > 0) {
				...
				if(!empty($send)) {
					...
					$this->display('aroomv2/datasetting_announcement_edit');
				}
			}
		}
	}
	...
	public function teacherteam() {
		...
		$this->display('aroomv2/datasetting_teacherteam');
	}
	public function teacherteam_add() {
		if($this->input->post()){
			...
			$this->display('aroomv2/datasetting_teacherteam_add');
		}
	...
	public function teacherteam_edit() {
		if($this->input->get('itemid')){
			...
			$Upcontrol = Ebh::app()->lib('UpcontrolLib');
			$this->assign('Upcontrol',$Upcontrol);
			$this->display('aroomv2/datasetting_teacherteam_edit');
	...
	public function information(){
		...
		$this->assign('tag',$tag);
		$this->display('aroomv2/datasetting_information');
	}
	public function information_add(){
		...
		$this->assign('editor',$editor);
		$this->assign('tag',$tag);
		$this->display('aroomv2/datasetting_information_add');
	}
	...
	public function information_edit(){
		...
		$this->assign('editor',$editor);
		$this->assign('tag',$tag);
		$this->display('aroomv2/datasetting_information_edit');
		exit;
		}
		if($this->input->post()){
			$rec = safeHtml($this->input->post(),array('message'));
	...
	public function advertisement(){
		...
		$this->assign('tag',$tag);
		$this->display('aroomv2/datasetting_advertisement');
	}
	public function advertisement_add(){
		...
		$this->assign('editor',$editor);
		$this->assign('tag',$tag);
		$this->display('aroomv2/datasetting_advertisement_add');
	}
	public function advertisement_edit(){
		...
		$editor = Ebh::app()->lib('UMEditor');
		$this->assign('editor',$editor);
		$this->display('aroomv2/datasetting_advertisement_edit');
		exit;
		}
		if($this->input->post()){
			$rec = safeHtml($this->input->post(),array('message'));
	...
	public function contact(){
		...
		$editor = Ebh::app()->lib('UMEditor');
		$this->assign('editor',$editor);
		$this->display('aroomv2/datasetting_contact');
