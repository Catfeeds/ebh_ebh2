...
class SelectcourseController extends CControl{
	...
	public function courselist(){
		...
		$mnlib->getmodulename($this,array('modulecode'=>'selectcourse','tors'=>1,'crid'=>$roominfo['crid']));
		$this->display('troomv2/selectcourse_list');
	}
	...
	public function student_view() {
		...
		$this->assign('pagestr',$pagestr);
		$this->display('troomv2/selectcourse_student');
	}
