...
class TeacherController extends CControl {
    ...
    public function add() {
        ...
        if ($tname !== NULL) {   //表单提交
            ...
            $this->display('troomv2/teacher_add');
        }
    }
    ...
    public function edit_view() {
        ...
        $this->display('troomv2/teacher_edit');
    }
    ...
    public function view() {
        ...
        $this->assign('teacher', $teacher);
        $this->display('troomv2/teacher_view');
    }
	...
	*/
	public function classes_view(){
		...
		$this->display('troomv2/teacher_classes');
	}
	...
	*/
	public function course_view(){
		...
		$this->assign('tuser',$tuser);
		$this->display('troomv2/teacher_course');
	}
	...
	*/
	public function courseware_view(){
		...
		$this->display('troomv2/teacher_courseware');
	}
	...
	*/
	public function askme_view(){
		...
		$this->assign('folderlist',$folderlist);
		$this->assign('tuser',$tuser);
		$this->display('troomv2/teacher_askme');
	...
	*/
	public function answer_view(){
		...
		$this->assign('tuser',$tuser);
		$this->assign('folderlist',$folderlist);
		$this->display('troomv2/teacher_answer');
	}
	...
	*/
	public function review_view(){
		...
		$this->assign('pagestr',$pagestr);
		$this->assign('tuser',$tuser);
		$this->display('troomv2/teacher_review');
	}
	...
	*/
	public function teacherlist(){
		...
		$this->assign('pagestr',$pagestr);
		$this->display('troomv2/teacher_list');
	}
	...
	*/
	public function viewnav(){
		$this->display('troomv2/teacher_viewnav');
	}
	...
	*/
	public function cwstudylog_view(){
		...
		$this->assign('pagestr',$pagestr);
		$this->display('troomv2/courseware_studylog');
	}
	...
	*/
	public function exam_view(){
		...
		$this->display('troomv2/exam_list');
	}
