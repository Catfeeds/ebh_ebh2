 ...
 * examv2导入主观题word上传
 */
class Doswordv2Controller extends CControl {
	...
	public function index() {
		...
		$parserurl = $_UP['wordparser']['spostpath'];
	...
	*返回页面html代码
	*/
	function gethtml($errormsg=NULL,$return_domain=NULL) {
		$html=<<<myhtml
			<!DOCTYPE HTML>
			<html>
			<head>
			...
			<div class="bianju">
			<form id="wordform" action="/troomv2/doswordv2.html" method="post" enctype="multipart/form-data">
			...
			<p class="zuoyexia"><span style="font-weight:bold;">作业参考格式下载：</span>　<a href="http://exam.ebanhui.com/static/html/dialog/wordlib/s2003.doc" class="word" target="_blank">Word2003版本</a>　<a href="http://exam.ebanhui.com/static/html/dialog/wordlib/s2007.docx" class="word" target="_blank">Word2007版本</a></p>
			</div>
