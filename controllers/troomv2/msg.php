...
class MsgController extends CControl{
	...
	public function message()
	{
		...
		$queryarr['typelist'] = '1,3,6';//类型为系统信息和私信
		...
		$this->display('troomv2/msg_message');
	}
	...
	public function question()
	{
		...
		$this->assign('msglist', $msglist);
		$this->assign('pagestr', $pagestr);
		$this->display('troomv2/msg_question');
	...
	public function answer()
	{
		...
		$this->assign('msglist', $msglist);
		$this->assign('pagestr', $pagestr);
		$this->display('troomv2/msg_answer');
	...
	public function review()
	{
		...
		$this->assign('msglist', $msglist);
		$this->assign('pagestr', $pagestr);
		$this->display('troomv2/msg_review');
	...
	public function sendlist()
	{
		...
		$this->assign('msglist', $msglist);
		$this->assign('pagestr', $pagestr);
		$this->display('troomv2/msg_sendlist');
