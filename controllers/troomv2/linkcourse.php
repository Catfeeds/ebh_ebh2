...
class LinkcourseController extends CControl{
	...
	*/
	public function index(){
        ...
        $this->display('troomv2/linkcourse_cor');
	}
	/**
	*班级作业对应的具体班级
	*/
	public function my() {
        ...
        if(!empty($classList)){
            foreach ($classList as $class) {
                ...
                if($class['grade'] > 0){
                    ...
                    $gradeClassDb[$class['grade'].'_'.$class['district']][] = '<a href="/troomv2/linkcourse/my-0-0-0-'.$class['classid'].'.html">'.$class['classname'].'</a>';
                }
            }
        }
		...
		$this->display('troomv2/linkcourse_my');
	}
    ...
    public function coursesDialog() {
        ...
        $this->display('troomv2/classsubject_fordialog');
    }
	...
	*/
    public function view() {
        ...
        $this->display('troomv2/classsubject_view_fordialog');
    }
