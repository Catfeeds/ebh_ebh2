...
class ClasspaperController extends CControl {
    ...
    public function index() {
		...
		$this->display('troomv2/classpaper');    }
	/*
	*批改作业
	*/
	public function cor(){
        ...
        $this->display('troomv2/classpaper_cor');
	...
	*/
	public function my() {
		...
		if(is_numeric($classid) && $classid > 0) {
			...
			$this->display('troomv2/classpaper_my');
		}
	}
	/**
	*班级作业对应的作业批阅
	*/
	public function all() {
		...
		$this->assign('roominfo',$roominfo);
		$this->assign('myclass',$myclass);
		$this->display('troomv2/classpaper_all');
	}
...
/**
	...
	*/
	public function todayexams() {
		...
		$this->assign('myclass',$myclass);
		$this->assign('d',$d);
		$this->display('troomv2/classpaper_today');
	}
}
