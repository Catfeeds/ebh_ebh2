...
class TeachingplanController extends CControl{
	...
	public function index(){
		$this->display('troomv2/teachingplan');
	}
	...
	public function add(){
		...
		if($this->input->post()){
			...
			$this->display('troomv2/teachingplan_add');
		}
	}
	/*
	教案管理页面
	*/
	public function manage(){
		...
		$this->display('troomv2/teachingplan_manage');
	}
	...
	public function view(){
		...
		$this->display('troomv2/teachingplan_view');
	}
	...
	public function edit_view(){
		...
		if($this->input->post()){
			...
			$this->assign('editor',$editor);
			$this->assign('tplandetail',$tplandetail);
			$this->display('troomv2/teachingplan_edit');
		}
	...
	*/
	public function uploadtplanattach(){
		if($this->input->post()){
			...
			$this->assign('_UP',$_UP);
			$this->display('troomv2/uploadtplanattach');
		}
	}
