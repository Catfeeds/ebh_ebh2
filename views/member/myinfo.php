...
<div class="yongrig">
<p><span style="font-size:24px;font-weight:bold;margin-right:20px;"><?=$memberInfo['nickname']?></span><?=$memberInfo['email']?><span>(<?=$memberInfo['username']?>)</span></p>
<p>个性签名：<span><?=$memberInfo['mysign']?></span></p>
</div>
</div>
<div class="yonghu">
<!--<p>昵　　称：<span>职业学生</span></p>-->
<span style="width:180px;float:left;">姓　　名：<span><?=$memberInfo['realname']?></span></span>

</div>
<div class="yonghu">
<p>个　　人：<span><?=$memberInfo['sex']==0?'男':'女' ?></span>
<span><?=empty($memberInfo['birthdate'])?'':date('Y-m-d',$memberInfo['birthdate'])?></span>
<!--　属兔　水瓶座　AB型 -->
<p>现 居 地：<span id="city"></span></p>
</p>
</div>
<div class="yonghu">
<p>手机号码：<span><?=$memberInfo['mobile']?></span></p>
<p>微　　信：<span><?=$memberInfo['msn']?></span></p>
<p> Q　　　Q：<span><?=$memberInfo['qq']?></span></p>
<p>邮　　箱：<span><?=$memberInfo['email']?></span></p>
</div>
<div class="yonghu" style="border:none;">
<p>简　　介：<span><?=$memberInfo['profile']?></span></p>
</div>
</div>
...
function getcityname(){
	return $.ajax({ 
		...
		type:"post",
		data:{citycode:<?=$memberInfo['citycode']?>},
		async:false,
  	}).responseText;
}
$(function(){
