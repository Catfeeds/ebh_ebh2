...
<div class="user-main clearfix" >
	...
	<div class="ter_tit">
	当前位置 > <a href="<?php echo geturl('member/myask')?>">我的答疑</a> > 我的关注
	<div class="diles">
	...
	<div class="lefrig" style="background:#fff;border:solid 1px #cdcdcd;margin-top:15px;width:786px;float:left;">
			...
			<div >
				<div class="work_mes">
					<ul>
						<li><a href="<?php echo geturl('member/myask');?>"><span>全部问题</span></a></li>
						...
						<li class="workcurrent"><a href="<?php echo geturl('member/myask/myfavorit')?>"><span>我的关注</span></a></li>
					</ul>
				</div>
				<div class="tiezi_search" style="height:20px;float:right;margin-top:10px;margin-right:10px;">
						
						<div style="margin-left:10px;float:left;"><a style="margin-left:10px;" class="questionbutton" href="<?php echo geturl('member/myask/addquestion')?>">提&nbsp;&nbsp;问</a></div>
				</div>
...
function serc(){
	...
	var url = '/member/myask/myfavorit-0-0-0.html?q='+title;
  // alert(url);
	window.location.href=url;
}
function cancelatten(qid) {
		$.ajax({
