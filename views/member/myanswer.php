...
<div class="user-main clearfix" >
	...
	<div class="ter_tit">
	当前位置 > <a href="<?php echo geturl('member/myask')?>">我的答疑</a> > 我的回答
	<div class="diles">
			...
			<div >
				<div class="work_mes">
					<ul>
						...
						<li class="workcurrent"><a href="<?php echo geturl('member/myask/myanswer');?>"><span>我的回答</span></a></li>
...
function serc(){
	...
	var url = '/member/myask/myanswer-0-0-0.html?q='+title;
  // alert(url);
