...
<link rel="stylesheet" type="text/css" href="http://static.ebanhui.com/ebh/tpl/2012/css/editdata.css">
...
<table width="740" class="datatabsim" style="font-size:12px;">
	<thead class="tabheadsim">
		...
		<tr>
			...
			<td width="238"><span class="width175" id="realname_span" maxlength="18"><?=$memberdetail['realname']?></span><input type="text"  class="uipt w165 spfl" style="display:none" value="<?=$memberdetail['realname']?>" id="realname" maxlength="16"/>
			<?php if(empty($memberdetail['realname'])){ ?>
			<span class="spfl"><a href="javascript:;" style="color:#2da8cb;" onclick="upinfo('realname','','<?=$memberdetail['realname']?>')" id="realname_but" name="realname_but">[修改]</a><a href="javascript:;" onclick="upinfo('realname','cancel','')" style="color:#2da8cb;display:none;" id="realname_cancel">[取消]</a></span>
			<?php } ?>
			</td>
			<td width="105" align="center">性&nbsp;&nbsp;&nbsp;&nbsp;别</td>
			<?php $selectsex[$memberdetail['sex']]='selected="selected"';?>
			<td width="244"><span class="width185"  id="sex_span"><?=$memberdetail['sex']==0?'男':'女'?></span><select id="sex" style="display:none;width:170px;"  class="uipt spfl"><option value="0" <?=!empty($selectsex[0])?$selectsex[0]:''?>>男</option><option value="1" <?=!empty($selectsex[1])?$selectsex[1]:''?>>女</option></select><span class="spfl"><a href="javascript:;" onclick="upinfo('sex','','<?=$memberdetail['sex']?>')" id="sex_but" name="sex_but" style="color:#2da8cb;">[修改]</a><a href="javascript:;" onclick="upinfo('sex','cancel','')" style="color:#2da8cb;display:none;" id="sex_cancel">[取消]</a></span></td>
		</tr>
		...
		<tr>
			...
			<td width="238"><span class="width185" id="birthdate_span"><?=$memberdetail['birthdate']?Date('Y-m-d',$memberdetail['birthdate']):''?></span><div id="birthdate" style="display:none;float:left;width:170px;"><input id="datebox" name="birthdate" class="easyui-datebox" value="<?=$memberdetail['birthdate']?Date('Y-m-d',$memberdetail['birthdate']):'1991-01-01'?>"></div><span class="spfl"><a href="javascript:;" style="color:#2da8cb;" onclick="upinfo('birthdate','','<?=Date('Y-m-d',$memberdetail['birthdate'])?>')" id="birthdate_but" name="birthdate_but">[修改]</a><a href="javascript:;" onclick="upinfo('birthdate','cancel','')" style="color:#2da8cb;display:none;" id="birthdate_cancel">[取消]</a></span></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><span class="width185" id="phone_span"><?=$memberdetail['phone']?></span><input type="text" class="uipt w165 spfl" style="display:none;width:160px;" id="phone" value="<?=$memberdetail['phone']?>" /><span class="spfl"><a href="javascript:;" onclick="upinfo('phone','','<?=$memberdetail['phone']?>')" style="color:#2da8cb;" id="phone_but">[修改]</a><a href="javascript:;" onclick="upinfo('phone','cancel','')" style="color:#2da8cb;display:none;" id="phone_cancel">[取消]</a></span></td>
		</tr>
		...
		<tr>
			...
			<td><span class="width185" id="msn_span"><?=$memberdetail['msn']?></span><input type="text" class="uipt w165 spfl" style="display:none;width:160px;" id="msn" value="<?=$memberdetail['msn']?>" /> <span class="spfl"><a href="javascript:;" onclick="upinfo('msn','','<?=$memberdetail['msn']?>')" style="color:#2da8cb;" id="msn_but">[修改]</a><a href="javascript:;" onclick="upinfo('msn','cancel','')" style="color:#2da8cb;display:none;" id="msn_cancel">[取消]</a></span></td>
		</tr>

		<tr>
			<td width="105" align="center">邮箱</td>
			<td colspan="3"><span class="width564" id="email_span"><?=$memberdetail['email']?></span><input class="uipt w165 spfl" type="text" style="display:none;" id="email" value="<?=$memberdetail['email']?>" /> <span class="spfl"><a href="javascript:;" onclick="upinfo('email','','<?=$memberdetail['email']?>')" style="color:#2da8cb;" id="email_but">[修改]</a><a href="javascript:;" onclick="upinfo('email','cancel','')" style="color:#2da8cb;display:none;" id="email_cancel">[取消]</a></span></td>
		</tr>
		...
		<tr>
			...
			<td><span class="width185" id="familyemail_span" maxlength="50"><?=$memberdetail['familyemail']?></span><input type="text" class="uipt w165 spfl" style="display:none;width:160px;" id="familyemail" value="<?=$memberdetail['familyemail']?>" /><span class="spfl"><a href="javascript:;" onclick="upinfo('familyemail','','<?=$memberdetail['familyemail']?>')" style="color:#2da8cb;" id="familyemail_but">[修改]</a><a href="javascript:;" onclick="upinfo('familyemail','cancel','')" style="color:#2da8cb;display:none;" id="familyemail_cancel">[取消]</a></span></td>
		</tr>
		<tr>
...
.datatabsim .tabheadsim .width185 {
    float: left;
    padding-left: 5px;
    width: 165px;
}
		...
		if(_type=='[修改]'){
			...
			if(id == 'phone'){
				...
				if(phone!='' && !pattern.test(phone)){
					alert("请输入正确的电话号码！(如：0571-88888888)");
					return false;
				}
			}
			if(id == 'qq'){
			...
			if(id == 'msn'){
				...
				if(msn!='' && !pattern.test(msn)){
					alert("请输入正确的微信号！(支持6-20个字母、数字、下划线和减号，必须以字母开头)");
					return false;
				}
			}
			if(id == 'profile'){
