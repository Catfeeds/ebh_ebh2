...
<div class="user-main clearfix" >
	...
	<div class="ter_tit">
	当前位置 > <a href="<?php echo geturl('member/myask')?>">我的答疑</a> > 我的问题
	<div class="diles">
			...
			<div >
				<div class="work_mes">
					<ul>
						...
						<li class="workcurrent"><a href="<?php echo geturl('member/myask/myquestion');?>"><span>我的问题</span></a></li>
...
function serc(){
	...
	var url = '/member/myask/myquestion-0-0-0.html?q='+title;
  // alert(url);
