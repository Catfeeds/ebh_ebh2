...
<div class="cright_cher">
		...
		当前位置 > <a href="<?=geturl('member/score/routinetask')?>">我的积分</a> > 兑换记录
		</div>
...
?>
<table width="786" border="0" cellpadding="0" class="datatabs" style="margin-top:10px;">
<tbody class="tabhead">
  <tr>
...
?>
<table width="786" border="0" cellpadding="0" class="datamis" style="border-left:none;border-right:none;">
  <tr>
    <td width="13%"><img width="85px;" heigth="55px;" src="<?= getThumb($ol['image'],'85_55')?>" /></td>
	<td width="22%" style="text-align:left;"><p>积分兑换</p><p class="yanse"><a href="<?=geturl('score/'.$ol['pid'])?>"><?=$ol['productname']?></a></p></td>
    <td width="10%">1</td>
