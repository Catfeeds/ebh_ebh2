		...
		<form id="askform">
			<div class="biaowaim" style="float: right;margin-top:10px;">
				...
				<div class="fontfen" style=" margin-left: 15px;_margin-top:10px;">
					<span class="wenzid">分&nbsp;&nbsp;&nbsp;&nbsp;类：</span>
					<div class="lases" style="margin-left:30px;_margin-left:10px;">
				...
				<div class="outlei" style="display:none;top:74px;">
					<h2 class="fenleitit">
...
function addquestion() {
    $.ajax({
                url:"<?= geturl('member/myask/addquestion') ?>",
                type: "POST",
