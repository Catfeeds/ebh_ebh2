...
<div class="user-main clearfix">
	...
	当前位置 > <a href="<?=geturl('member')?>">个人信息</a> > 修改密码
	</div>
...
<p style="color:#817f7f;">定期修改密码，有助于保护您的账号安全及个人隐私<a style="color:#1996e6;font-weight:bold;" href="http://www.ebh.net/forget.html"> 忘记密码？</a></p>
</div>
<div class="etatb">
...
<a href="javascript:void(0)" onclick="chkform()" class="borhuangbtn" style="height:36px;line-height:36px;font-size:14px;font-weight:bold;margin-top:40px;margin-left:120px;">确认</a>
</div>
