...
<form id="mainform" action="/myroom/evaluate/result.html?ttype=2" method="post">
<input type="hidden" id="page"  name="page" value="1"  autocomplete="off" />
<input type="hidden"  id="maxpage"  name="maxpage" value="<?=ceil(count($evaluate_jiaolv)/10)?>" autocomplete="off"  />
<ul>
<?php
foreach($evaluate_jiaolv as $k=>$q){
...
<p><?=$k?>.<?=$q?></p>
<label><span class="greigd"><input name="q<?=$k?>" type="radio" value="3" class="radios"/> 很符合</span></label>
<label><span class="greigd"><input name="q<?=$k?>" type="radio" value="2" class="radios"/> 比较符合</span></label>
<label><span class="greigd"><input name="q<?=$k?>" type="radio" value="1" class="radios"/> 较不符合</span></label>
<label><span class="greigd"><input name="q<?=$k?>" type="radio" value="0" class="radios"/> 很不符合</span></label>
</li>
<?php
}
?>
