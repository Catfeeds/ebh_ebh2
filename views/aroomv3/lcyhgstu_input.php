...
<form id="inputform" action="<?=geturl('/aroomv2/lcyhstu/input.html?aroomv=3')?>" method="post" enctype="multipart/form-data">
...
<input class="xuetjbtn" type="button" value="继续导入" onclick="window.location.href='<?=geturl('/aroomv2/lcyhstu/input.html?aroomv=3')?>'" />
	<?php }else{?>
<br />
...
<input class="xuetjbtn" type="button" value="重新导入" onclick="window.location.href='<?=geturl('/aroomv2/lcyhstu/input.html?aroomv=3')?>'" />
</p>
<?php }}?>
