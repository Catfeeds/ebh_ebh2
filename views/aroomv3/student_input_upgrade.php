...
<form id="inputform" action="<?=geturl('/aroomv2/student/input_upgrade.html?aroomv=3')?>" method="post" enctype="multipart/form-data">
...
<input class="xuetjbtn" type="button" value="继续导入" onclick="window.location.href='<?=geturl('/aroomv2/student/input_upgrade.html?aroomv=3')?>'" />
...
<input class="xuetjbtn" type="button" value="重新导入" onclick="window.location.href='<?=geturl('/aroomv2/student/input_upgrade.html?aroomv=3')?>'" />
