...
<script type="text/javascript">
    ...
    function _renderRow(k,v){
        ...
        row.push('<td class="op">&nbsp;&nbsp;[<a href="javascript:void(0)" onclick="showaddin(\'/admin/appmodule/classroomedit.html?crid='+v.crid+'\',\'选择模块\')">编辑</a>]&nbsp;&nbsp;</td>');
...
$('#pp').pagination({
	...
	onSelectPage:function(pageNumber, pageSize){
		...
		$.post("/admin/appmodule/getListAjaxModule.html?moduleid=<?php echo $moduleid?>",
