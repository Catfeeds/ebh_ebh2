...
<form method="post" action="/admin/pads/add.html" onsubmit="return check();">
  <table cellspacing="0" cellpadding="0" width="100%"  class="maintable">
  <br /><br />
  <tr>
    <th>广告标题<span>＊</span></th>
    <td><input maxlength="200" class="w300" type="text" name="subject" id="subject"  value=""   onblur="return checktext()" />
    </td>
  </tr>
...
<tr>
  ...
  <td>从<input type="text" id="begintime" name="begintime" class="w150" value="<?=time()?>" onfocus="$(this).datetimebox({showSeconds:false});" />
       开始到 <input type="text" id="endtime" name="endtime"   class="w150"  value="<?=date('Y-m-d H:i',strtotime('+ 1 year'))?>" onfocus="$(this).datetimebox({showSeconds:false});" />
       结束
  </td>
</tr>
...
<tr>
  ...
  <td><input type="text"  name="linkurl" class="w300" value="" /></td>
</tr>
<tr>
  <th>排列顺序</th>
  <td><input type="text"  name="displayorder" id="displayorder" class="w50" value="0" onblur="return check_num()" /></td>
</tr>

<tr>
  <th>锁定状态</th>
  <td>
    <input type="radio" name="status" value="1" checked=checked>不锁定
...
<tr>
  ...
  <td colspan="2" style="padding:0;">
    <?php $editor->createEditor('message',"100%","500px"); ?>
  </td>
</tr>
</table>
<div class="buttons">
