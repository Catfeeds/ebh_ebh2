...
<form  method="post" action="/admin/padstypes/add.html" onsubmit="return checkAll()">
...
<tr><th>模板<p></p></th><td><input type="text" class="w300" id="templet" name="templet" value=""></td></tr>
