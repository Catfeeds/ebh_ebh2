...
<body>
<h1>添加文件</h1>
        <form id="form_rfile" method="post" novalidate action="<?php echo geturl('admin/rfile/add');?>">
            <div class="fitem">
                <label>文件标题</label>
            ...
            <div class="fitem">
                <label>所属教师：</label>
                <input class="easyui-validatebox" required="true" validType="" missingMessage="选择教师" invalidMessage="2" id="teacher_input" readonly="true">
				<input name="uid" id="teacher_hidden" readonly="true">
			...
			<div class="fitem">
                <label>置顶级别</label>
				<input type="radio" name="top" class="easyui-validatebox" checked>非置顶
			...
			<div class="fitem">
                <label>精华级别</label>
				<input type="radio" name="best" class="easyui-validatebox" checked>非精华
			...
			<div class="fitem">
                <label>排序号</label>
                <input name="displayorder" class="easyui-validatebox" required="true" value="500">
            </div>
        </form>
    </div>
