    ...
    <tbody>
        <tr>
            ...
            <td class="actions">
                ...
                <tbody><tr>
                <td class="active"><a href="/admin/news.html">浏览资讯</a></td>
                <td><a href="/admin/news/add.html" class="add">添加资讯</a></td>
                </tr>
                </tbody></table>
            </td>
        </tr>
...
<div id="newslisttab">
<ul>
    <li class="active"><a href="/admin/news/index.html" >所有状态</a></li>

    <li class="" folder=1><a href="/admin/news/index.html">待审箱</a></li>

    <li class="" folder=2><a href="/admin/news/index.html">发布箱</a></li>
</ul>
...
<table cellspacing="0" cellpadding="0" class="toptable">
        ...
        <?php $this->widget('category_widget',array('where'=>array('type'=>'news'),'tag'=>'category')); ?>
        </select>
         <span>
            <select name='channel' id="channel">
            <option value="0" >所有频道</option>
            <?php $this->widget('category_widget',array('where'=>array('type'=>'courseware','position'=>1),'tag'=>'channel','selected'=>'')); ?>
            </select>
        </span>
        &nbsp;&nbsp;
...
<script type="text/javascript">
    ...
    function _renderRow(k,v){
        ...
        row.push('<td class="op">'+'<a href='+'/admin/items/add.html?type=<?=$type?>&itemid='+v.itemid+'>'+'[编辑]'+'</a>'+'&nbsp;&nbsp;<a href="javascript:return false" onclick="return del('+v.itemid+')" itemid='+v.itemid+'>'+'[删除]'+'</a>'+'</td>');
        row.push('</tr>');
        return row.join('');
    }
</script>
...
<td>
    <select name="category2" id="category2">
     <?php $this->widget('category_widget',array('where'=>array('type'=>'news'),'tag'=>'category2','selected'=>'')); ?>
    </select>
</td>
</tr>
</tbody></table>
    ...
    $(function(){
        $('#newslisttab li').click(function(){
			...
			if($(this).attr('folder')==undefined)
				$("#folder").removeAttr('name');
			else{
				$("#folder").attr('name','folder');
