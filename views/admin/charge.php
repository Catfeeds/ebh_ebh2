...
<script type="text/javascript">
    ...
    function _renderRow(k,v){
        ...
        row.push('<td class="title" nowrap>￥ '+v.value+'</td>');
...
<form name="listform" id="theform">
<input type="hidden" name="formhash" value="52b016b0" />
<table cellspacing="0" cellpadding="0" width="100%"  class="listtable">
<tbody class="agentbody">
<tr>
	<th>序号</th>
	<th>选择</th>
	<th fieldname="i.uid" width="10%">充值会员</th>
	<th fieldname="i.toid">充值金额</th>
	<th fieldname="i.fromip">操作IP</th>
	<th fieldname="i.[dateline]">充值时间</th>
</tr>
</tbody>
...
<script type='text/javascript'>
    ...
    onSelectPage:function(pageNumber, pageSize){
        ...
        $.post("/admin/charge/getListAjax.html",
