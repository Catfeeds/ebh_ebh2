...
<table summary="" id="pagehead" cellpadding="0" cellspacing="0" border="0" width="100%">
	<tbody><tr>
		...
		<td class="actions">
			...
			<tbody>
				<tr>
					<td class="active"><a href="/admin/pcategories.html">浏览分类</a></td>
					<td><a href="/admin/pcategories/add.html" class="add">添加分类</a></td>
				</tr>
			</tbody></table>
		</td>
	</tr></tbody>
...
<?php foreach ($pcategoriesList as $k=>$v){?>
...
<td class="sn"><input type="text" name="order<?=$v['catid']?>" class="w50" value="<?=$v['displayorder']?>"></td><td class="sn">[<a href="/admin/pcategories/add.html?catid=<?=$v['catid']?>">添加子分类</a>]&nbsp;&nbsp;[<a href="/admin/pcategories/edit.html?catid=<?=$v['catid']?>&upid=<?=$v['upid']?>">编辑</a>]&nbsp;&nbsp;[<a onclick="_del(<?=$v['catid']?>)" href="#">删除</a>]</td>
</tr>
<?php }?>
</tbody>
</table>
...
<script type='text/javascript'>
	...
	function _move(catid,displayorder,upordown){
		$.post(
				...
				{catid:catid,upordown:upordown,displayorder:displayorder},
				function(message){
						window.document.write(message);
					}
				);
    ...
    function sortopAll(){
        ...
        $.post('/admin/pcategories/sortopAll.html',{param:res},function(message){
        		window.document.write(message);}
        		);
    }
    function noopAll(){
    ...
    function moveopAll(){
        ...
        $.post('/admin/pcategories/moveAll.html',
