    ...
    <div id="content">
      <div class="bgrcontent">
        <div class="bdrcontent">
            ...
            <a href="<?=$returnurl?>"><?=$note?><script>setTimeout("window.location.href ='<?=$returnurl?>';", 3000);</script><ajaxok></a>
            
            </p>
        </div>
        <div class="footactions">&nbsp; 
<a href="<?=$returnurl?>">确定</a> &nbsp; 
<a href="javascript:history.back();">返回上一页</a> &nbsp; <a href="/">首页</a></div>
      </div>
    </div>
</div>
</body>
