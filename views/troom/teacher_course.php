...
<div>
<div class="ter_tit">
		当前位置 > <a href="/troom/statisticanalysis.html">查询统计</a> > <a href="/troom/statisticanalysis/teach.html"> 教师统计 </a> > 课程查看
	</div>
<div class="coursecheck">
	<table cellpadding="0" cellspacing="0" class="tables">
		...
		<tr>
			...
			<td width="151"><a href="<?=geturl('troom/teacher/courseware/'.$this->uri->itemid).'?rurl='.$rurl.'&selfolderid='.$folder['folderid'].'&rrurl='.$rrurl?>">查看</a></td>
		</tr>
        <?php }?>
	</table>
    <div class="button2 fr"><a href="<?=empty($rrurl)?geturl('troom/report/teacher'):'/'.$rrurl.'.html'?>">返 回</a></div>
</div>
</body>
</html>
