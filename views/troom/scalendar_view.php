...
<![endif]-->
<div class="ter_tit">
当前位置 > <a href="<?=geturl('troom/tastulog') ?>">学生监察</a> >
	 <a href="<?= geturl('troom/scalendar-0-0-0-0-'.$type) ?>"><?= $typename ?></a> > <?= empty($student['realname'])?$student['username']:$student['realname'] ?>的<?= $typename ?>
</div>
