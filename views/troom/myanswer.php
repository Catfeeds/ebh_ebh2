...
<div class="ter_tit">
当前位置 > <a href="<?= geturl('troom/myask') ?>">师生答疑</a> > 我的回答
<div class="diles">
	<?php
		$q= empty($q)?'':$q;
		if(!empty($q)){
...
<div class="workol">
	...
	<div class="work_mes">
		<ul class="extendul">
			...
			<li class="workcurrent"><a href="<?= geturl('troom/myask/myanswer') ?>"><span>我的回答</span></a></li>
...
$(function() {
   ...
   $("#ser").click(function(){
       ...
       if(title == searchtext) 
           title = "";
       var url = '<?= geturl('troom/myask/myanswer') ?>' + '?q='+title;
