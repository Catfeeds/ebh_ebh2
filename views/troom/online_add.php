...
<div class="ter_tit">
	当前位置 > <a href="<?= geturl('troom/online')?>" >在线直播</a> > 添加直播
</div>
...
<script>
	...
	function beforesubmit(){
		...
		$.post("/troom/online/add.html",{param:$("#formdata").serialize()},function(message){
				if(message=="1"){
					$.showmessage({
						message:'添加成功！',
						callback :function(){
                            document.location.href = "/troom/online/allcourse.html";
                        }});
				}
				else
