...
<div class="lefrig">
	<div class="myxuan">
		...
		<!-- 班级发送 -->
		<!-- <li class="mytiku">
		<a href="<?= geturl('troom/weixin/student_send_msg') ?>"></a>
		</li> -->
		<!-- 班级群发 -->
		<li class="comtiku" target="_blank">
		<a href="<?= geturl('troom/weixin/class_send_msg') ?>"></a>
		</li>
		<!-- 家长回复 -->
		<li class="myxuex">
		<a href="<?= geturl('troom/weixin/parent_send') ?>"></a>
		</li>
		<!-- 历史信息 -->
		<li class="history">
		<a href="<?= geturl('troom/weixin/list_msg') ?>"></a>
		</li>
		</ul>
	</div>
</div>
