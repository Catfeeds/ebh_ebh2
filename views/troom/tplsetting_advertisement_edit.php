...
<div class="ter_tit">
当前位置 > <a href="/troom/tplsetting/advertisement.html">广告管理</a> > 添加广告</div>
<div class="lefrig">
...
$("#savebtn").click(function(){
      if(submit_check()) {
        var url="<?= geturl('troom/tplsetting/advertisement/edit')?>";
        $.ajax({
          url:url,
          type: "POST",
          ...
          success:function(data){
            if(data == 'success') {
              $.showmessage({
                ...
                title:'修改广告',
                callback :function(){
                   document.location.href = "<?= geturl('troom/tplsetting/advertisement') ?>";
                }
              });
            } else {
              $.showmessage({
