...
<div class="tiezitool"><a class="jiabgbtn hongbtn" style="width:110px;" href="<?= geturl('troom/tplsetting/teachertheam/add')?>" >添加团队成员</a></div>
	 ...
	 <tbody>
				  ...
				  <tr>
					...
					<td width="15%"><div class="teac_manage">
						<a class="workBtn" onclick="location.href='#geturl(troom/setting/tplsetting/teachertheam/add-0-0-0-$value[itemid])#'" >修改</a>
...
function serc(){
	var subject = $("#subject").val();
		...
		subject = subject.replace(/\#/g,"");
		subject = subject.replace(/\%/g,"");
	var url = '#geturl(troom/setting/tplsetting/teachertheam-0-0-0-'+subject+')#';
 // alert(url);
