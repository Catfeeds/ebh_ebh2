...
<div class="ter_tit">
	当前位置 &gt; <a href="<?=geturl('troom/examapply')?>">认证管理</a> &gt; 未通过
        <div class="diles fr">
    ...
    <div class="workol">
        <div class="work_mes">
            <ul class="extendul">
                ...
                <li class="workcurrent"><a href="<?=geturl('troom/examapply/unpassapply')?>"><span>未通过</span></a></li>
            </ul>
        </div>
        <div class="clear"></div>
...
function _search(){
	...
	if(searchkey == '请输入学生姓名或登录帐号')
		searchkey = '';
	location.href = '<?=geturl('troom/examapply/unpassapply')?>?q='+searchkey;
}
