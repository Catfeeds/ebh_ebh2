...
<div class="ter_tit">
当前位置 > <a href="<?= geturl('troom/tastulog') ?>">学生监察</a> > <a href="<?= geturl('troom/scalendar-0-0-0-0-0-3') ?>">学习记录</a> > <a href="<?= geturl('troom/scalendar/'.$memberid.'-0-0-0-3') ?>"><?= $membername ?>的学习记录</a>
			<div class="diles">
