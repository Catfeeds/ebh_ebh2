...
<div class="ter_tit">
当前位置 > <a href="<?= geturl('troom/msg') ?>">我的消息</a> > 新评论
...
<div class="workol">
	<div class="work_mes">
		<ul>
			...
			<li class="workcurrent"><a href="<?= geturl('troom/msg/review') ?>"><span>新评论</span></a></li>
		</ul>
	</div>
												...
												<div style="float:left;margin-right:15px;"><img title="<?= empty($value['realname'])?$value['username']:$value['realname'] ?>" src="<?=$face?>" /></div>
													<div style="float:left;width:690px;font-family:Microsoft YaHei;">
                                                        ...
                                                        ?>
                                                        	...
                                                        	<a style="color:#2696f0;font-weight:bold;text-decoration:underline;" href="<?= geturl('troom/course/'.$value['sourceid']) ?>" target="_blank"><?= $value['message'] ?></a> 发表了评论
                                                        </p>
