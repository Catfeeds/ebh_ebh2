...
<div class="work_mes">
	<ul>
		<li class="workcurrent"><a href="<?= geturl('troom/myonline')  ?>"><span>我的直播</span></a></li>
	...
	<?php foreach ($courseList as $value) {?>
		<tr onmouseout="this.bgColor='#ffffff'"	onmouseover="this.bgColor='#f2f7ff'" style="border-bottom:1px solid #efefef;">
	      <td style=" height: 35px;width:29%"><a  href="/troom/myonline/edit.html?op=view&id=<?=$value['id']?>" style="padding:5px 10px 5px;width:200px;word-wrap: break-word;float:left;color:blue; cursor: pointer;font-size:12px;" title="<?$value['title']?>"><?=$value['title']?></a></td> 
		   ...
		   <!-- <a href="/troom/myonline/edit.html?pos=my&op=view&id=<?=$value['id']?>" class="btnsuo" >查看</a> -->
		   <a href="javascript:" onclick="return degroup('<?=$value["id"]?>','<?=$value["title"]?>')" style="margin-left:0;margin-right:5px;" class="btnshan">删除</a>
		   <?php if(time()<=($value['cdate'])+$value['ctime']*60){?>
		   		<a href="/troom/myonline/edit.html?pos=my&id=<?=$value['id']?>" class="workBtn" style="margin-right:5px;height: 22px;line-height: 23px;">修改</a>
		   <?php }?>
		   <?php 
...
function _dosearch(){
	...
	location.href='/troom/myonline.html?q='+q;
}
