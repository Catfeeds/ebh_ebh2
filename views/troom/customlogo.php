...
<div class="ter_tit">
当前位置 > <a href="<?=geturl('troom/setting/avatarold')?>">教室头像</a> > 自定义头像
</div>
...
<div class="work_menu">
						<ul>
							<li class="workcurrent"><a href="<?=geturl('troom/setting/avatarold')?>"><span>自定义头像</span></a></li>
							<li><a href="<?=geturl('troom/setting/roomlogo')?>"><span>系统头像</span></a></li>
						</ul>
					</div>
