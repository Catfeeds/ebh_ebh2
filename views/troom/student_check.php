...
<div class="ter_tit">
    当前位置 > <a href="<?= geturl('troom/student') ?>">学员管理</a> > 学员审核
</div>
<div class="lefrig">
    ...
    <div class="work_menuss">
        <ul>
            ...
            <li class="workcurrent"><a href="<?= geturl('troom/student/check') ?>"><span>学员审核</span></a></li>
...
<!--
    ...
    function submitapply() {
        var url = "<?= geturl('troom/student/check') ?>";
        $.ajax({
            url: url,
            type: 'post',
    ...
    $(function() {
        $('#searchbutton').click(function() {
            var href = '<?= geturl('troom/student/check') ?>';
