...
<div class="work_menu" >
<ul>
<li class="workcurrent"><a href="/troom/tplsetting/information.html"><span>资讯列表</span></a></li>
<li><a href="/troom/tplsetting/information_add.html"><span>发布资讯</span></a></li>
</ul>
<div class="tiezitool"><ul><li><a class="lvbtn" href="/troom/tplsetting/information/add.html">发布新资讯</a></li></ul></div>
</div>
...
<td width="16%"><a class="workBtn" onclick="location.href='/troom/tplsetting/information_edit.html?itemid=<?=$oneNews["itemid"]?>'">修改</a>
...
$.confirm("您确定要删除【" + subject + "】广告吗？",function(){
    $.ajax({
      url:"/troom/tplsetting/information_del.html",
      type:'post',
...
subject = subject.replace(/\#/g,"");
subject = subject.replace(/\%/g,"");
var url = '/troom/tplsetting/information-0-0-0.html?q='+subject;
