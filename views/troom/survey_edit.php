...
<script type="text/javascript" src="http://static.ebanhui.com/ebh/js/mysurveytroom.js?version=20151217001"></script>
	...
	<div>
		...
		<fieldset class="relatefs">
			...
			<div style="margin-left: 20px;">
                    <input id="startdate" class="qisties" readonly="readonly" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'<?=Date('Y-m-d',SYSTIME)?>'});" value="<?=empty($survey['startdate'])?date('Y-m-d',SYSTIME):date('Y-m-d',$survey['startdate'])?>"/>
                    <span class="sjzjf">&mdash;</span>
					<input id="enddate" class="qisties" readonly="readonly" type="text"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'startdate\')}'});" value="<?=empty($survey['enddate'])?date('Y-m-d',SYSTIME+604800):date('Y-m-d',$survey['enddate'])?>"/>
			</div>
		</fieldset>
