...
<br/>      
<form id="upform"  action="/troom/tplsetting/advertisement_add.html" method="post" onsubmit="return submit_check()">
...
$("#savebtn").click(function(){
      if(submit_check()) {
        var url="<?= geturl('troom/tplsetting/advertisement/add')?>";
        $.ajax({
          url:url,
          type: "POST",
