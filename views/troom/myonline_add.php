...
<div class="work_mes">
	<ul>
		...
		<!-- <li><a href="<?= geturl('troom/myonline/all')  ?>"><span>所有直播</span></a></li> -->
		<li class="workcurrent"><a href="<?= geturl('troom/myonline/add')?>"><span>添加直播</span></a></li>
...
<script>
	...
	function beforesubmit(){
		...
		$.post("/troom/myonline/add.html",{param:$("#formdata").serialize()},function(message){
				if(message=="1"){
					$.showmessage({
						message:'添加成功！',
						callback :function(){
                            document.location.href = "/troom/myonline.html";
                        }});
				}
				else
