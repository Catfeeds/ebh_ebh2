...
<div class="ter_tit">
当前位置 > <a href="<?= geturl('troom/classsubject') ?>">课程列表</a> > <a href="<?= geturl('troom/classsubject/'.$course['folderid'])?>"><?= $course['foldername']?></a> > 修改附件
</div>
<div class="lefrig" style="background:#fff;float:left;margin-top:15px;width:788px;padding-top:10px;">
<form id="upform">
...
//		}
		...
		function submitform() {
			var url="<?= geturl('troom/classcourse/editattach') ?>";
			$.ajax({
				url:url,
				type:"post",
				dataType:"json",
