...
<div class="ter_tit">
	...
	<a href="/troom/classcourse/jkexcel-0-0-1-<?= $course['cwid'];?>.html" class="addbtnas previewBtn" target="_blank">导 出</a>
...
<div class="workol" style="float:left; margin-top:15px;">
	<div class="work_mes">
		<ul>
			<li><a href="<?= geturl('troom/classcourse/jk-0-0-0-'.$course['cwid']) ?>"><span>学习跟踪</span></a></li>
			<li  class="workcurrent"><a href="<?= geturl('troom/classcourse/jk-0-0-1-'.$course['cwid']) ?>"><span>未学名单</span></a></li>
		</ul>
	</div>
