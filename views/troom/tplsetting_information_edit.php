...
<div class="ter_tit">
当前位置 > <a href="/troom/setting/tplsetting/information.html">资讯管理</a> > 发布资讯</div>
<div class="lefrig">
...
<ul>
<li ><a href="/troom/tplsetting/information.html"><span>资讯列表</span></a></li>
<li class="workcurrent"><a href="/troom/tplsetting/information/add.html"><span>发布资讯</span></a></li>
</ul>
</div>
...
$("#savebtn").click(function(){
      if(submit_check()) {
        var url="<?= geturl('troom/tplsetting/information/edit')?>";
        $.ajax({
          url:url,
          type: "POST",
          ...
          success:function(data){
            if(data == 'success') {
              $.showmessage({
                ...
                title:'编辑资讯',
                callback :function(){
                   document.location.href = "<?= geturl('troom/tplsetting/information') ?>";
                }
              });
            } else {
              $.showmessage({
