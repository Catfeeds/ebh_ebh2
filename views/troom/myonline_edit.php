...
<div class="work_mes">
	<ul>
		<li <?php if($pos=='my'){echo 'class=workcurrent';}?>><a href="<?= geturl('troom/myonline')  ?>"><span>我的直播</span></a></li>
		<!-- <li <?php if($pos=='all'){echo 'class=workcurrent';}?>><a href="<?= geturl('troom/myonline/all') ?>"><span>所有直播</span></a></li> -->
...
<script>
	...
	function beforesubmit(){
		...
		$.post("/troom/myonline/edit.html",{param:$("#formdata").serialize()},function(message){
				if(message=="1"){
					$.showmessage({
						message:'编辑成功！',
						callback :function(){
