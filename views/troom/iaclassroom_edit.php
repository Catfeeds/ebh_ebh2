...
<div class="lefrig" style="background:#fff;float:left;margin-top:15px;width:788px;">
		...
		<form id="upform">	
			...
			<tr>
				...
				<td colspan="3">
					<textarea style="padding-left: 5px;line-height: 1.5;padding: 5px;height:80px;width:630px;" name="title" id="message" rows="10" maxlength="500" onblur="submit_check('message')"><?=$ia['title']?></textarea>
