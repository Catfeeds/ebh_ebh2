...
<div class="ter_tit">
	当前位置 &gt; <a href="<?=geturl('troom/examapply')?>">认证管理</a> &gt; <a href="<?=geturl('troom/examapply')?>">成绩统计</a> &gt; 未通过
        <div class="diles fr">
    ...
    <div class="workol">
        <div class="work_mes">
            ...
            <ul class="extendul">
                ...
                <li class="workcurrent"><a href="/troom/examapply/resultfail/<?=$eid?>.html"><span>未通过</span></a></li>
...
function _search(){
	...
	if(searchkey == '请输入学生姓名或登录帐号')
		searchkey = '';
	location.href = '<?=geturl('troom/examapply/resultfail/'.$eid)?>?q='+searchkey;
}
function _examexcel(){
	var startdate = $('#startdate').val();
	var enddate = $('#enddate').val();
	location.href = '/troom/examapply/examexcel/<?=$eid?>.html?type=2&startdate='+startdate+'&enddate='+enddate;
}
