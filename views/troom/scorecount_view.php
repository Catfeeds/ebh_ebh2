...
.tiezitoolss a.excelbtn{
	...
	<div class="ter_tit">
		当前位置 > <a href="<?= geturl('troom/statisticanalysis') ?>">统计分析</a> > <a href="<?= geturl('troom/statisticanalysis/scorecount') ?>">成绩统计</a> > <?= $myclass['classname']?>
		<div class="tiezitoolss" >
		<a class="excelbtn" href="/troom/statisticanalysis/scexcel.html?eid=<?=$eid?>"> 导出excel</a>
		</div>
	</div>
	<div class="lefrig">
	</div>
