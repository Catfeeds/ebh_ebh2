...
<div class="cright_cher" style="width:978px;margin-bottom:20px;">
<div class="ter_tit" >
...
<div class="lefrig">
    <div class="classbox" style="margin-top:5px;width:978px;background: #FFF;">
        ...
        <div class="classboxmore" style="width:948px;">
...
function comment(){
   ...
   $(function (){
	...
	function formatasklist(list){
		...
		html+= '		<a target="_blank" href="/troom/myask/'+list.qid+'.html" style="color:#777;font-weight:bold;">';
		if(list.status == 1){
