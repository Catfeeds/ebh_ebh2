...
<div class="ter_tit">
	当前位置 &gt; <a href="<?=geturl('troom/examapply')?>">认证管理</a> &gt; 已通过
        <div class="diles fr">
...
<div class="lefrig" style="min-height:1000px;">
    <div class="workol">
        <div class="work_mes">
            <ul class="extendul">
                <li><a href="<?=geturl('troom/examapply/applylist')?>"><span>待审核</span></a></li>
                <li class="workcurrent"><a href="<?=geturl('troom/examapply/passapply')?>"><span>已通过</span></a></li>
...
<?php foreach($applylist as $apply){?>
                <tr >
                    ...
                    <td><a href="javascript:;" onclick="applydetail(<?=$apply['applyid']?>)" class="annius">取消通过</a></td>
                </tr>
<?php }?>
			</table>
		</div>
        ...
        <div class="bottoms">
            ...
            <div class="fl ml20"><a id="donopass" href="javascript:;" class="result ml15">批量取消</a></div>
        </div>
        <div class="clear"></div>
<?=$pagestr?>
	</div>
...
function _search(){
	...
	if(searchkey == '请输入学生姓名或登录帐号')
		searchkey = '';
	location.href = '<?=geturl('troom/examapply/passapply')?>?q='+searchkey;
}
