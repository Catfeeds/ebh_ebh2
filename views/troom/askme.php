...
<div class="ter_tit">
当前位置 > <a href="<?= geturl('troom/myask') ?>">师生答疑</a> > 向我提的问题
<div class="diles">
	<?php
		$q= empty($q)?'':$q;
		if(!empty($q)){
...
<div class="workol">
	<div class="work_mes">
		<ul class="extendul">
			<li class="workcurrent"><a href="<?= geturl('troom/myask/askme') ?>"><span>提给我的</span></a></li>
...
initsearch("title",searchtext);
   $("#ser").click(function(){
       ...
       if(title == searchtext) 
           title = "";
       var url = '<?= geturl('troom/myask/askme') ?>' + '?q='+title;
