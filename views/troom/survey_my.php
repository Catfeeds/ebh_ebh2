...
<div class="ter_tit">
	当前位置 > <a href="<?=geturl('troom/survey')?>" ?>调查问卷</a> > 我的问卷
</div>
<div class="lefrig" style="background:#fff;margin-top:15px;">
	<div class="work_mes">
		<ul class="extendul">
			<li><a href="/troom/survey.html"><span>全部问卷</span></a></li>
			<li class="workcurrent"><a href="/troom/survey/my.html"><span>我的问卷</span></a></li>
		</ul>
	</div>
	...
	<div class="workdata" style="float:left;margin-top:0">
		...
		<?php if(!empty($surveylist)){
			...
			<tr>
				...
				<td width="88"><?=date('Y-m-d H:i:s',$survey['dateline'])?></td>
