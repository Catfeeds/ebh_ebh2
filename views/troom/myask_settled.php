...
<div class="ter_tit">
当前位置 > <a href="<?= geturl('troom/myask') ?>">师生答疑</a> > 已解决
<div class="diles">
	<?php
		$q= empty($q)?'':$q;
		if(!empty($q)){
...
<div class="workol">
	<div class="work_mes">
		<ul class="extendul">
			...
			<!-- 新增 -->
			<li class="workcurrent"><a href="<?= geturl('troom/myask/settled') ?>"><span>已解决</span></a></li>
...
$(function() {
   ...
   $("#ser").click(function(){
       ...
       if(title == searchtext) 
           title = "";
       var url = '<?= geturl('troom/myask/settled') ?>' + '?q='+title;
