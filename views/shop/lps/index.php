...
<?php }?>
<title>欢迎来到六盘水钟山区空中课堂在线学习平台！！</title>
</head>
...
.zybz {
	...
	height:740px;
	min-width:1000px;
	background:url(http://static.ebanhui.com/ebh/tpl/2016/images/lps1.jpg) no-repeat center;
	font-family:微软雅黑;
}
.nisrtd {
	width:1000px;
...
.naisrs a {
	...
	float:left;
	display:block;
	margin:260px 0 0 123px;
	transition: all 0.65s ease-out 0s;
	opacity:0;
}
.naisrs a:hover {
	background:url(http://static.ebanhui.com/ebh/tpl/2016/images/husor1.png) no-repeat;
	opacity:1;
}
.fldty {
	color:#fff;
...
<div class="zybz">
	<div class="nisrtd">
    	<div class="topler">
			<span>欢迎来到六盘水钟山区空中课堂在线学习平台！</span>
            <div class="frsre">
        ...
        <div class="naisrs">
        	<a href="http://lpszsxx.ebh.net/"></a>
        	<a href="http://lpszscz.ebh.net/"></a>
        </div>      
    </div>
</div>
<script type="text/JavaScript">
