...
<img src="http://static.ebanhui.com/ebh/tpl/default/images/titzizhan0411.jpg" /><span style="float:left;">共有课程 <span><?= $zwxcount['count']?></span> 个</span><a href="<?= geturl('platform')?>" class="lieico" style="text-decoration:none;display:inline;">列表</a>
</div>
	<ul class="append_new">
	...
	<?php if(!empty($zwxlist)){
		...
		?>
		<a target="_blank" href="<?= $cloudurl?>" style=" text-decoration:none;"><h3 class="ketit"><?= shortstr($k['crname'],24,'')?></h3></a>
		<div class="kewaik">
		...
		<?php }elseif(empty($user)){ ?>
			<input class="xuexibtns" type="submit" value="开始学习"  onclick="javascript:;"  name='http://<?= $k['domain']?>.ebanhui.com'/>
		<?php }else{ ?>
...
<?php } ?>
<div class="sanad" style="height:810px;">
