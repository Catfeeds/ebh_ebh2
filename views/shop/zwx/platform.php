...
<style>
.kaitongbtn2 {
    background: url(http://static.ebanhui.com/ebh/tpl/default/images/kaitongbtn0411.jpg) no-repeat scroll 0 0 transparent;
    border: medium none;
    color: #FFFFFF;
    cursor: pointer;
    font-size: 14px;
...
<div class="lefzong">
<div class="titzizhan">
<img src="http://static.ebanhui.com/ebh/tpl/default/images/titzi0217.jpg">
</div>
...
?>
	...
	<a target="_blank">
	<input class="kaitongbtn2" type="submit" onclick="location.href='<?= $cloudurl?>'" value="马上进入" name="Submit2">
	</a>
	<?php }else{ ?>
		<?php if(!empty($rmuser)){ ?>
		<a target="_blank">
	<input class="kaitongbtn2" type="submit" onclick="location.href='<?= $cloudurl?>'" value="开始学习" name="Submit2">
	</a>
		<?php }else{ ?>
		<a target="_blank">
