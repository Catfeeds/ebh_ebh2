...
<?php }?>
<?php $crarr = array(
	'jsjtyz'=>array('title'=>'金坛区第一中学'),
	'jsjtsz'=>array('title'=>'金坛区第四中学'),
	'hlgzx'=>array('title'=>'江苏省华中'),
	'jsgz'=>array('title'=>'金沙中学'),
	);
	$roominfo = Ebh::app()->room->getcurroom();
?>
<title><?=empty($crarr[$roominfo['domain']]['title'])?'':$crarr[$roominfo['domain']]['title']?></title>
</head>
...
<div style="background:#ff8800;font-size:14px;color:#fff;z-index: 10;height:30px;line-height:30px;width:100%;text-align:center;font-family: Microsoft Yahei;"><img style="vertical-align: text-bottom;" src="http://static.ebanhui.com/ebh/tpl/2016/images/zhuyi01.jpg" />亲爱的用户：为了给您提供更优质的服务，系统将于06月28号22点30分进行升级，期间可能会出现服务中断情况，敬请谅解！</div><!-->
    ...
    <div class="wrap" style="background: url(http://static.ebanhui.com/ebh/tpl/2016/images/<?=empty($crarr[$roominfo['domain']])?'default':$roominfo['domain']?>.jpg?v=03) no-repeat center;height:auto;min-height:980px;position: relative;">
    	...
    	<div class="wrapson">
			...
			<input type="hidden" name="loginsubmit" value="1" />
				<div class="wrapdenglu" style="top:280px;">
					<h2>用户登录</h2>
		...
		<?php if(isApp()==false){?>
		<?php
		$icp = '<a href="http://www.miibeian.gov.cn/" style="color: #fff;" target="_blank">  浙B2-20160787</a> Copyright &copy; 2011-' . date('Y') . ' ebh.net All Rights Reserved';
		if (!empty($room) && !empty($room['icp']))
			$icp = $room['icp'];
		?>
		<div class="footer" style="position:absolute;bottom:0px;width:100%;color: #fff;">
			<P style="color: #fff"></P><?= $icp ?></P>
		</div>
		<?php }?>
		<!-- 统计代码开始 -->
		<?php
