        ...
        if (count($varpool['sublist']) == 1) { ?>
            <div class="navcm-float-content" style="width:1140px;">
                <?php if (!empty($varpool['sublist'][0])) { ?>
                    ...
                    <div class="timeb" style="width:100%;text-align:center;margin:0">
                        <span style="margin:0">时间：<?=Date('Y-m-d H:i',$varpool['sublist'][0]['dateline'])?></span>
                        <span>阅读：<?=$varpool['sublist'][0]['viewnum']+1?></span>
                    </div>
                    <!-- Baidu Button BEGIN -->
                   ...
                   --> <!-- Baidu Button END -->
					<?php if(empty($varpool['sublist'][0]['isinternal']) || !empty($varpool['isroomuser'])){?>
                    ...
                    <div>
                        ...
                        <?php if(!empty($varpool['sublist'][0]['attachlist']) && (empty($varpool['sublist'][0]['isinternal']) || !empty($varpool['isroomuser']))){//非内部用户不可见
                            foreach($varpool['sublist'][0]['attachlist'] as $attach){?>
