...
<head>
	<meta charset="utf-8">
    <?php if (!empty($course['title'])) {$inner_data['title']= $course['title'];}?>
	<title><?=!empty($inner_data['title']) ? $inner_data['title'] : empty($roomdetail['crname'])?$roominfo['crname']:$roomdetail['crname']?></title>
