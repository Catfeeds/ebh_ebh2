...
<head>
	...
	<!-- 微信端 过来查看 允许缩放 -->
	<meta name="viewport" content="width=1200, user-scalable=<?=(true || is_weixin()==true)?"yes":"no"?>" />
    ...
    <link rel="stylesheet" type="text/css" href="http://static.ebanhui.com/design/css/module.css" />
        ...
        <script>
            ...
            var roominfo = <?=!empty($plateRoom) ? json_encode($plateRoom):'{}'?>;
...
<?php } else { ?>
    ...
    <div class="wrap_footer">
        <div class="wrap_footerson">
            <div class="footersonleft"<?php if (!empty($roomdetail['crid']) && in_array($roomdetail['crid'], array(14443, 14441, 14439, 14401, 14395))) { ?> style="visibility: hidden"<?php } ?>>
