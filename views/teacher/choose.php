...
$roomurl = empty($proom['fulldomain']) ? $proom['domain'].'.ebh.net' : $proom['fulldomain'];
$troomurl = gettroomurl($proom['crid']);
$proomurl = 'http://'.$roomurl.$troomurl;
?>
...
$troomurl = gettroomurl($croom['crid']);
$croomurl = 'http://'.$croom['domain'].'.ebh.net'.$troomurl;
?>
