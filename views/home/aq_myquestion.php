...
<div class="user-main clearfix" >
		<div class="">
	<div class="ter_tit">
	当前位置 > <a href="<?php echo geturl('home/largedb')?>">历史数据</a> > 我的问题
	<div class="diles">
			...
			<div >
				<div class="weaktil">
					<ul>
						...
						<li class="datek"><a href="<?php echo geturl('home/largedb/aqquestion');?>"><span>我的问题</span></a></li>
						<li><a href="<?php echo geturl('home/largedb/aqanswers');?>"><span>我的回答</span></a></li>
						<li><a href="<?php echo geturl('home/largedb/aqfavorit')?>"><span>我的关注</span></a></li>
					</ul>
				</div>
...
function serc(){
	...
	var url = '/home/largedb/aqquestion-0-0-0.html?q='+title;
  // alert(url);
