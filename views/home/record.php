...
<tbody class="tabhead">
  <tr>
					<th align="left" width="35%" style="padding-left: 15px;border-bottom: 1px solid #e1e1e1;">来源/用途</th>
					<th align="left" width="10%"  style="border-bottom: 1px solid #e1e1e1;">数量</th>
					<th align="center" width="15%"  style="border-bottom: 1px solid #e1e1e1;">支出</th>
					<th align="center" width="25%"  style="border-bottom: 1px solid #e1e1e1;">日期</th>
					<th align="center" width="15%"  style="border-bottom: 1px solid #e1e1e1;">备注</th>
					</tr>
</tbody>
</table>
