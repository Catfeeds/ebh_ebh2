...
<div class="user-main clearfix" >
		<div class="">
	<div class="ter_tit">
	当前位置 > <a href="<?php echo geturl('home/largedb')?>">历史数据</a> > 我的回答
	<div class="diles">
			...
			<div >
				<div class="weaktil">
					<ul>
						...
						<li class="datek"><a href="<?php echo geturl('home/largedb/aqanswers');?>"><span>我的回答</span></a></li>
...
function serc(){
	...
	var url = '/home/largedb/aqanswers-0-0-0.html?q='+title;
  // alert(url);
