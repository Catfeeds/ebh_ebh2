...
<div class="">
	...
	<?php
			...
			foreach($roomlist as $room){
				$flg = '.ebh.net';
				$roomurl = empty($room['fulldomain']) ? $room['domain'].$flg : $room['fulldomain'];
				$room['murl'] = 'http://'.$roomurl.'/myroom.html';
	...
	?>
		<div class="lc_detail">
			<ul>
				...
				<p class="due">服务到期时间：<span style="color:#1061a7; font-weight:bold; margin-right:20px;"><?php echo empty($room['enddate'])?'无限制':Date('Y-m-d',$room['enddate'])?></span></p>
				</li>
