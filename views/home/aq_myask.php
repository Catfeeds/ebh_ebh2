...
<div class="user-main clearfix" >
		<div class="">
	<div class="ter_tit">
	当前位置 > <a href="<?php echo geturl('home/largedb')?>">历史数据</a> > 全部问题
	<div class="diles">
	...
	<div class="lefrig" style="background:#fff;border:solid 1px #cdcdcd;margin-top:15px;width:786px;float:left;">
			...
			<div>
                <div class="weaktil">
					<ul>
						<li class="datek"><a href="<?php echo geturl('home/largedb/aqindex');?>"><span>全部问题</span></a></li>
...
function serc(){
	...
	var url = '/home/largedb/aqindex-0-0-0.html?q='+title;
  // alert(url);
