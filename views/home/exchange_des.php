...
.eotle{border-left:none; border-right:none; border-bottom:none;}
</style>
...
<div class="lefrig" style="margin-top:15px;background:#fff;">
	<div class="work_menu" style="width:1000px; position:relative;margin-top:0px;">
		<ul>
			 <li><a href="<?=geturl('home/score/lottery/exchange')?>" style="font-size:16px;line-height: 33px;border:none;"><span>兑换礼品</span></a></li>
			 <li class="workcurrent"><a href="<?=geturl('home/score/lottery/exchange_des')?>" style="font-size:16px;"><span>兑换说明</span></a></li>
		</ul>
	</div>
    <div class="eotle" style="border-top:none">
        ...
        <div class="lianst">
            <ul>
                <li class="qqiclian">
                <a href="http://wpa.qq.com/msgrd?v=3&amp;uin=1808609435&amp;site=qq&amp;menu=yes" target="_blank" class="ekrtu"></a>
                </li>
                <li class="kficlian">
