...
.datatab td {
	...
	<div class="lefrig" style="background:#fff;float:left;margin-top:15px;width:800px;">
...
$(function(){
	$('#searchbutton').click(function(){
		var href = '<?=geturl('aroom/astulog/astuloglist_fordialog-0-0-0-'.$uid.'-'.$folderid.'-searchvalue')?>';
