...
<form id="inputform" action="<?=geturl('aroom/tclassconnect')?>" method="post" enctype="multipart/form-data">
  <input style="float:left;width:350px;height:30px;cursor:pointer;" type="file" name="inputfile" />
  <input name="flag" type="hidden"/>
  <a style="float:right" href="<?=geturl('aroom/classes')?>" class="flhui">返回</a>
