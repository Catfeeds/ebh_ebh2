...
<form id="inputform" action="<?=geturl('aroom/student/input_upgrade')?>" method="post" enctype="multipart/form-data">
...
<input class="xuetjbtn" type="button" value="继续导入" onclick="window.location.href='<?=geturl('aroom/student/input_upgrade')?>'" />
...
<input class="xuetjbtn" type="button" value="重新导入" onclick="window.location.href='<?=geturl('aroom/student/input_upgrade')?>'" />
