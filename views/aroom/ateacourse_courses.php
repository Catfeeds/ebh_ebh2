...
.showimg { float:left;}
.showimg img { border:1px solid #efefef; padding:4px; position:relative; left:-4px; top:-5px;}
...
<div class="ter_tit">
		当前位置 > <a href="<?=geturl('aroom/ateacourse')?>">教师课件查看</a> > 教师课程
		</div>
	<div class="lefrig">
	...
	<?php foreach($courselist as $cl){
		$furl = geturl('aroom/ateacourse/course/courselist-1-0-0-'.$cl['folderid'].'-'.$uid);
	?>
	...
	<?=show_page($coursecount,$pagesize)?>
<div style="clear:both;"></div>
</div>
</div>