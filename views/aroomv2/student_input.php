...
<body>
<div class="ter_tit">
		当前位置 > <a href="<?=geturl('aroomv2/classstudent')?>">班级学生</a> > <a href="<?=geturl('aroomv2/student')?>">学生管理</a> > 批量导入
		</div>
...
<form id="inputform" action="<?=geturl('aroomv2/student/input')?>" method="post" enctype="multipart/form-data">
...
<input class="xuetjbtn" type="button" value="继续导入" onclick="window.location.href='<?=geturl('aroomv2/student/input')?>'" />
...
<input class="xuetjbtn" type="button" value="重新导入" onclick="window.location.href='<?=geturl('aroomv2/student/input')?>'" />
