...
<div class="ter_tit">
当前位置 > <a href="<?=geturl('aroomv2/module')?>">门户配置</a> > <a href="/aroomv2/moduledit.html">模块内容编辑</a> >广告管理</div>
...
<a class="jiabgbtn hongbtn" href="/aroomv2/information/ad/add.html<?=empty($type)?'':'?type='.$type?>">添加广告</a>
...
if(!empty($ads)){
	foreach($ads as $ad){?>
<tr> 
<td width="47%"><a href="/aroomv2/information/ad/edit.html?itemid=<?=$ad["itemid"]?>" title="<?=$ad['subject']?>"><?=shortstr($ad['subject'],20)?></a></td>
<td width="25%"><a href="<?=$ad['itemurl']?>" target="_blank"><?=$ad['itemurl']?></a></td>
<td width="12%"><?=$cates[$ad['catid']]?></td>
<td width="16%">
<a class="seedayi" href="/aroomv2/information/ad/edit.html?itemid=<?=$ad["itemid"]?>">修改</a>
<input type="button" class="seedayi" onclick="deadverdiv(<?=$ad['itemid']?>,'<?=$ad['subject']?>')" value="删除" /></div>
 </td>
 </tr>
 <?php }}else{?>
 <tr>
