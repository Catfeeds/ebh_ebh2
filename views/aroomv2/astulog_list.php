...
<link type="text/css" href="http://static.ebanhui.com/ebh/tpl/default/css/aroom/common.css" rel="stylesheet" />
<style>
.datatab td {
...
?>
	<div class="ter_tit">
		当前位置 > <a href="/aroomv2/report.html">统计分析</a> > <a href="/aroomv2/student/viewnav.html">学生查看</a> > <a href="/aroomv2/student/view.html">班级列表</a> <?php if(!empty($rrurl)){?>> <a href="/<?=$rurl?>.html?rurl=<?=$rrurl?>">学生列表</a><?php } ?> > 听课监察
		<div class="diles">
...
<a href="javascript:history.back();" class="tfanhui" style="left: 640px;_top:13px;position: absolute;width:90px;">返回上一页</a>
</div>
...
$(function(){
	$('#searchbutton').click(function(){
		var href = '<?=geturl('aroomv2/astulog/astuloglist-0-0-0-'.$uid.'-searchvalue')?>';
