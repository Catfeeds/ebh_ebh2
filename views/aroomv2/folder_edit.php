...
<form id="foldervalue" action="<?=geturl('aroomv2/folder/edit')?>" method="post">
...
<div class="cqshangc">
	...
	<span class="pxxuanx">课程名称：</span>
	  <input name="foldername" id="foldername" type="text" onblur="checkfoldername()" class="inpxuanx" style="width: 332px;background: url(http://static.ebanhui.com/ebh/tpl/2012/images/inp_bg01.png) no-repeat;" value="<?=$folder['foldername']?>" maxlength="20"/>
