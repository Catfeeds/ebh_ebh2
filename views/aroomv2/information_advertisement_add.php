...
<div class="ter_tit">
当前位置 > <a href="/aroomv2/information/advertisement.html">广告管理</a> > 添加广告</div>
...
<br/>      
<form id="upform"  action="/aroomv2/information/advertisement_add.html" method="post" onsubmit="return submit_check()">
...
$("#savebtn").click(function(){
      if(submit_check()) {
        var url="<?= geturl('aroomv2/information/advertisement/add')?>";
        $.ajax({
          url:url,
          type: "POST",
