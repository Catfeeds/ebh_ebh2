...
.terlie .mylabelhover a.labeldel img {
	...
	<div class="ter_tit">
		当前位置 > <a href="<?= geturl('aroomv2/course') ?>">课程管理</a> > 添加目录
		</div>
...
<form id="foldervalue" action="<?=geturl('aroomv2/folder/add')?>" method="post">
...
<div class="cqshangc">
	...
	<div class="xgtxBtn" style="margin-top:15px;width:220px;"><a href="javascript:;" class="borlanbtn btnlogo" >确 认</a><a href="javascript:history.go(-1)" class="borlanbtn " style="margin-left:10px;" >返回</a></div>
	</div>
  <div class="cqrightsc">
	...
	<input class="lanbtn100 marlef75" style="display:inline;" type="button" id="cqbc" value="修改目录封面" name="Submit">
	</div>
</div>
</form>
...
<div class="tab_box" style="background:#fff;main-height:620px;<?=$picstyle?>">
