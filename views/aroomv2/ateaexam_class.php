...
<a class="tfanhui" href="<?=geturl('aroomv2/ateaexam')?>" style="left: 640px;_top:13px;position: absolute;width:90px;">返回上一页</a>
</div>
...
<tbody>
	...
	?>
		<tr>
			...
			<td width="20%"><a href="<?=geturl('aroomv2/ateaexam/class/exam/'.$cl['classid'].'-0-0-0-'.$uid)?>" class="previewBtn" title="班级作业">班级作业</a></td>
		</tr>
		<?php }?>
