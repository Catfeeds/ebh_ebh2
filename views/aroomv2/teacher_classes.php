...
<div>
<div class="ter_tit">
        当前位置 > <a href="<?=geturl('aroomv2/report')?>">统计分析</a> > <a href="<?=geturl('aroomv2/report/teacher')?>"> 教师统计 </a> > 任教班级
...
<div class="teachclass">
	<table cellpadding="0" cellspacing="0" class="tables">
		...
		<tr >
            ...
            <td width="223"><a href="<?=geturl('aroomv2/student/list/'.$class['classid']).'?rurl='.$rurl.'&rrurl='.$rrurl?>">学生列表</a></td>
        </tr>
		<?php }?>
    </table>
