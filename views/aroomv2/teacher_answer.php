...
?>
	...
	<?php }else{?>
		当前位置 > <a href="<?=geturl('aroomv2/report')?>">统计分析</a> > <a href="<?=geturl('aroomv2/report/teacher')?>"> 教师统计 </a> > 答疑查看
	<?php }?>
	</div>
    	...
    	<tr  class="second">
        	<td width="786" colspan="7">
           		<div>
                    ...
                    <div class="quest fl" style="font-size:16px;"><p>　　该教师共回答了 <?=$totalanswercount?> 个问题</p></div>
                        <ul style="padding-top:5px; max-height:150px; overflow:auto;">
        ...
        <tr >
            ...
            <td width="127">
				<?php if(empty($answer['shield'])){?>
					<a href="<?=geturl('aroomv2/information/ateaask/'.$answer['qid']).'?rurl='.$this->uri->path.'&rrurl='.$rurl?>">
					查看详情</a>
