...
?>
<div class="ter_tit">
当前位置 > <a href="<?=geturl('aroomv2/setting/avatarold')?>">网校校徽</a> > 系统校徽
</div>
<div class="lefrig" style="background:#fff;float:left;margin-top:15px;width:788px;">
<div class="workol">
<div class="work_menu">
	<ul>
		<li><a href="<?=geturl('aroomv2/setting/avatarold')?>"><span>自定义头像</span></a></li>
		<li class="workcurrent"><a href="<?=geturl('aroomv2/setting/roomlogo')?>"><span>系统头像</span></a></li>
	</ul>
		</div>
	<div class="tab_box" style="border:none;">
		<div class="ecenter">
				...
				<div class="xttxlist">
					<ul>
						<?php for($i=1;$i<=18;$i++){
							echo '<li><a href="javascript:;"><img width="100" height="100" Jimg="a" src="http://static.ebanhui.com/ebh/tpl/2012/images/face/'.$i.'.jpg" /></a></li>';
						}
						?>
					</ul>
				</div>
