<?php
$this->display('aroomv2/room_header');
$studentCount = 0;
if (!empty($course['student']) && is_array($course['student'])) {
    $studentCount = count($course['student']);
}
?>
...
<div style="width:1000px;margin:0 auto;">
    <div class="crightbottom" style="width:1000px;">
            <div class="xktitles" title="<?php echo $course['coursename']?>"><?php echo shortstr($course['coursename'],40)?><span class="xkjs1s">教师：<?php echo empty($course['realname'])?$course['username']:$course['realname']?></span></div>
        <p class="kclbtitle" style="float:left;"><span style="float:left;">课程介绍：</span><span class="textkcjs" style="white-space: normal;float:left;width:850px;"><?php echo $course['introduce']?></span></p>
        <div class="xklbtp">
        ...
        <p class="kclbtitle kclbtitle1s">报名情况：<span class="textkcjs" style="color:#ff3c00;"><?=$studentCount?></span><span class="textkcjs"> 人</span></p>
        ...
        <table cellpadding="0" cellspacing="0" class="bmlist">
            ...
            <?php }}else{?>
                <tr  class="zwnr1s"><td colspan="3" style=" border:none; background:#fff;"><div class="nodata"></div></td></tr>
            <?php }?>
        </table>
