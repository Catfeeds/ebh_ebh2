...
当前位置 > <a href="/aroomv2/information/datainfor.html">资讯管理</a> > 发布资讯</div>
...
<td width="880"><div ><span class="error" id="su" style="color:#999999;">请输入资讯标题,最少两个字。</span></div></td>
</tr>
<tr>
<td colspan=2><input style=" border: 1px solid #A0B5BB; height: 24px; line-height: 24px;margin-top: 5px;width: 930px; margin-bottom: 10px;  padding-left:5px; margin-left:21px;" id="subject" name="subject" type="text" maxlength="30" onblur="subjs($(this).val())" /></td>
</tr>
<tr>
<td><span style="float:right;" class="biaoti">资讯状态：</span></td>
<!--  -->
<td><div><span style="color:#999999;">请选择资讯状态，如果您选择禁用，将不在前台动态资讯页显示。</span></div></td>
</tr>
<tr>
<td ></td>
<td >
<div style="margin-top:5px; margin-bottom:10px;"><label><input type="radio" name="status" value="0" />禁用</label>
<label><input type="radio" name="status" value="1" CHECKED="CHECKED" />启用</label></div></td>
</tr>
...
<?php $navcode = $this->input->get('navcode');
if(!empty($navigatorlist)){
	foreach($navigatorlist as $nav){
	?>
		<option value="<?=$nav['code']?>" <?=($nav['code']==$navcode)?'SELECTED="true"':''?>><?=empty($nav['nickname'])?$nav['name']:$nav['nickname']?></option>
...
<tr>
	...
	<?php if ($roominfo['template'] == 'plate') { ?>
		<td>
			<a title="点我上传资讯图片" href="javascript:void(0)"  onclick="uploadlogo()" class="jnlihrey"><img style="float:left;" id="showclog" width="130" height="78" src="http://static.ebanhui.com/ebh/tpl/default/images/lstyjast.jpg"/></a>
			<div id="info-photowrap"></div>
		</td>
	<?php } else { ?>
		<td>
			<a title="点我上传资讯图片" href="javascript:void(0)"  onclick="uploadlogo()" class="jnlihrey"><img style="float:left;" id="showclog" width="130" height="98" src="http://static.ebanhui.com/ebh/tpl/default/images/lstyjast.jpg"/></a>
			<div id="info-photowrap"></div>
		</td>
	<?php } ?>
 </tr>
<tr>
<td><span style="float:right;" class="biaoti">资讯摘要：</span></td>
<td>
<div style=""><em class="error" id="no" style="color:#999999;">请输入资讯摘要，字数控制在5-200个字之间。</em></div>
</td>
</tr>
<tr>
<td colspan=2 ><textarea class="w545" id="note" name="note" rows="2" maxLength="200" style="resize:none;height: 70px; width: 930px;padding:4px;float:left;margin-left:21px;  margin-bottom:10px; margin-top:5px;" onblur="nots(this.value)" ></textarea></td>
</tr>
<tr>
<td><span style="float:right;" class="biaoti" >资讯内容：</span></td>
<td><div><em class="error" id="messa" style="color:#999999;"></em></div></td>
</tr>
<tr>
<td colspan=2 >
	<div style=" margin-bottom:10px; margin-top:5px;margin-left:21px;"> <?php $editor->createEditor('message',"940px",'800px');?></div>
       </td>
</tr>
</table>
<div class="clear"></div>
...
$("#savebtn").click(function(){
      if(submit_check()) {
        var url="<?= geturl('aroomv2/information/datainfor/add')?>";
        $.ajax({
          url:url,
          type: "POST",
...
$(function(){
	...
	window.preparexPhoto("photouploader",callback);
});
function uploadlogo(){
