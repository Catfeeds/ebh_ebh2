...
<div >
	<div class="ter_tit">
        当前位置 > <a href="/aroomv2/report.html">统计分析</a> > <a href="/aroomv2/student/viewnav.html">学生查看</a> > 班级列表
    </div>
    <div class="xueshengguanli">
    	...
    	<div class="xueshengguanli2_top fr">
            <ul>
                <li class="fl "><a href="javascript:addstudent()">添加学生</a></li>
                <li class="fl ml20"><a href="/aroomv2/student/input.html">批量导入</a></li>
                <li class="fl ml20"><a href="/aroomv2/student/input_upgrade.html">升班导入</a></li>
            </ul>
        </div>
        <div class="clear"></div>
        <div class="xueshengguanli_bottom">
        	<table cellpadding="0" cellspacing="0" class="tables">
                ...
                <tr >
                	<td width="132" ><p style="width:130px;word-wrap: break-word;float:left;"><b><?=$class['classname']?></b></p></td>
                    ...
                    <td width="82"><a href="<?=geturl('aroomv2/student/view/list/'.$class['classid']).'?rurl='.$rurl?>">学生列表</a></td>
                </tr>
				<?php }?>
...
function _search(){
	...
	if(searchkey == '请输入学生账号或姓名')
		searchkey = '';
	location.href = '/aroomv2/student/view/list_view.html?classid=0&rurl=<?=$rurl?>&q='+searchkey;
}
...
function saveadd(){
	...
	var realname = $('#user_add_realname').val();
