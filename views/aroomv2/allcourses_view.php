...
<script type="text/javascript">
	...
	<?php } ?>
		...
		<div class="ter_tit">
	当前位置 > <a href="<?= geturl('aroomv2/allcourses') ?>" >学校所有课程</a> > <a href="<?= geturl('aroomv2/allcourses/'.$course['folderid'])?>"><?= $course['foldername'] ?></a> > <?= $course['title']?>
</div>
<div class="lefrig" style="margin-top:10px;">
			<div class="classbox">
				...
				<div class="classboxmore">
					...
					<?php if(preg_match('/.*(\.ebh|\.ebhp)$/',$course['cwurl'])) {?>
						...
						<a href="<?= geturl('aroomv2/course/'.$course['cwid']) ?>" class="huangbtn marrig" target="_blank" style="float:right;margin-right:50px;">网页播放</a>
						<?php } ?>
					<?php } ?>
					</p>
				</div>
			...
			<div class="introduce" style="padding-top:10px;width:786px;">
				<div class="intitle">
		...
		<div class="intitle" style=" width: auto;"><h2><a id="rid">在线作业</a></h2></div>
            <div class="incont" style="width:786px;">
