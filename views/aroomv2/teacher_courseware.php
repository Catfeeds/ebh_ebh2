...
//			}
        ...
        <tr>
            ...
            <td width="139"><a target="<?=$target?>" href="<?=geturl('aroomv2/teacher/'.$coursetype.'/view-1-0-0-'.$cw['cwid'])?>">查看</a>&nbsp;&nbsp;&nbsp;<a href="<?=geturl('aroomv2/teacher/cwstudylog/'.$cw['cwid']).'?rurl='.$this->uri->path.'&rrurl='.$rurl?>">学习监控</a></td>
        </tr>
		<?php }
		}else{?>
