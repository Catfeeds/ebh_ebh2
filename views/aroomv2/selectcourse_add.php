...
<div class="ter_tit">
	当前位置 > <a href="<?=geturl('aroomv2/more')?>">更多应用</a> > <a href="<?=geturl('aroomv2/selectcourse/courselist')?>">选课管理</a> > 开设选课课程
</div>
			...
			<div id="hitdiv">
				<div class="cqleftsc">
					...
					<span class="pxxuanx">课程介绍：</span>
			  		<textarea name="summary" style="min-height: 200px;height:200px;float:left;" onblur="checksummary()" id="summary" class="w388 txt" value="" x_hit="课程详细介绍(800字以内)"></textarea>
					...
					<div style="width:500px;float:left;margin-top:10px;">
						...
						<div  class="inpxuanx" style="width:323px;padding-left:10px;background: url(http://static.ebanhui.com/ebh/tpl/2012/images/inp_bg01.png) no-repeat;">
							<input name="location" type="text" id="location" class="inpxuanx" style="width:310px;" value="" x_hit="上课地点"/>
						</div>
					</div>
					<div style="width:500px;float:left;margin-top:10px;">
						<span class="pxxuanx">招收人数：</span>
						<div  class="inpxuanx" style="width:323px;padding-left:10px;background: url(http://static.ebanhui.com/ebh/tpl/2012/images/inp_bg01.png) no-repeat;">
							<input name="admitnum" type="text" id="admitnum" class="inpxuanx" style="width:310px;" value="" x_hit="0"/>
						</div>
					</div>
					<div style="width:500px;float:left">
						<span class="pxxuanx">禁止报名：</span>
						<label><input style="margin-top:10px;float:left;width:26px;" type="radio" value="0" name="isforbidden" checked="checked"/><span style="float:left;margin-top:5px">允许报名</span></label>
						<label><input style="margin-top:10px;float:left;width:26px;" type="radio" value="1" name="isforbidden" /><span style="float:left;margin-top:5px">禁止报名</span></label>
					</div>
					<div style="float:left;width:490px;display: inline;">
						<span class="pxxuanx">适合年级：</span>
						<div style="width:84px; float:left;display:inline;"><label><input style="margin-top:5px;float:left;width:26px;" type="checkbox" value="0" name="allowgrade[]" checked="checked" /><span style="float:left;margin-right:10px;display:inline;">不限</span></label></div>
						<div style="width:84px; float:left;display:inline;"><label><input style="margin-top:5px;float:left;width:26px;" type="checkbox" value="1" name="allowgrade[]"/><span style="float:left;margin-right:10px;display:inline;">一年级</span></label></div>
						<div style="width:84px; float:left;display:inline;"><label><input style="margin-top:5px;float:left;width:26px;" type="checkbox" value="2" name="allowgrade[]"/><span style="float:left;margin-right:10px;display:inline;">二年级</span></label></div>
						<div style="width:84px; float:left;display:inline;"><label><input style="margin-top:5px;float:left;width:26px;" type="checkbox" value="3" name="allowgrade[]"/><span style="float:left;margin-right:10px;display:inline;">三年级</span></label></div>
						<div style="width:84px; float:left;display:inline;"><label><input style="margin-top:5px;float:left;width:26px;" type="checkbox" value="4" name="allowgrade[]"/><span style="float:left;margin-right:10px;display:inline;">四年级</span></label></div>
						<div style="width:84px; float:left;display:inline;"><label><input style="margin-top:5px;float:left;width:26px;" type="checkbox" value="5" name="allowgrade[]"/><span style="float:left;margin-right:10px;display:inline;">五年级</span></label></div>
						<div style="width:84px; float:left;display:inline;"><label><input style="margin-top:5px;float:left;width:26px;" type="checkbox" value="6" name="allowgrade[]"/><span style="float:left;margin-right:10px;display:inline;">六年级</span></label></div>
					</div>
