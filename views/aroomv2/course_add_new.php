...
<div class="">
	...
	<form id="courseaddform" autocomplete="off">
		...
		<div class="cernter">
			...
			<div class="sedres">
				<img id="folderimg" src="http://static.ebanhui.com/ebh/tpl/default/images/folderimgs/course_cover_default_247_147.jpg" style="width:247px;height:147px;" border="0">
			</div>
			<?php }else{?>
			<div class="sedresr">
				<img id="folderimg" src="http://static.ebanhui.com/ebh/images/nopic.jpg" style="width:114px;height:159px;" border="0">
			</div>
			<?php }?>
		...
		<span class="puspan redxing">课程名称：</span>
			<input class="shuter" name="foldername" type="text" id="foldername" value="" placeholder="如：高一语文（上册）" irequired="true"/>
		</div>
		<div class="ewartre">
		<span class="puspan redxing">课程介绍：</span>
			<textarea class="duosxsr" name="summary" maxlength="200" id="summary" cols="45" rows="5" placeholder="请输入课程简介" irequired="true"></textarea>
		</div>
		<div class="ewartre">
		<span class="puspan">主讲教师：</span>
			<input class="shuter" name="speaker" type="text" id="" value="" placeholder="如：吴老师（省特级数学老师）" />
		</div>
		<div class="ewartre">
		...
		<div class="ewartre" id="priceblock" style="">
			<div class="botmer">
				...
				<p class="huisrt"><span class="huisprt">课程价格：</span><input class="husrrt intinput" name="fprice" type="text" id="priceinput" value="" maxlength="9" irequired="true"/>元</p>
		...
		<span class="puspan redxing" style="width:115px;">课程有效期：</span>
			...
			<label class="lenwsie"><input style="vertical-align: middle;margin-right:5px;" class="bywhich" type="radio" name="bywhich" value="0" checked="checked"/>按月：</label>
				<input class="anyuedt intinput" name="imonth" type="text" id="bym_input" value="" maxlength="3" irequired="true"/><span class="jisrtwe">个月</span>
			</div>
			<div class="huierte">
			<label class="lenwsie"><input style="vertical-align: middle;margin-right:5px;" class="bywhich" type="radio" name="bywhich" value="1" />按日：</label>
				<input class="anyuedt intinput" style="background:#CCC" readonly="readonly" name="iday" type="text" id="byd_input" value="" maxlength="3"/><span class="jisrtwe">日</span>
			</div>
		</div>
		<div class="ewartre">
		<span class="puspan">详细介绍：</span>
			<div style="float:left">
			<?php $editor->xEditor('detail','650px','300px');?>
			</div>
		</div>
		...
		<div class="othersettings" style="display:none">
			...
			<p class="huretwes">
				<i class="wenicos aboutthis" tipid="coursetip"></i>
					...
					<label class="husirtrt aboutthis" tipid="gridtip"><input style="vertical-align: middle;margin-right:5px;" type="radio" name="view_mode" id="" value="0" checked="checked"/>网格模式</label>
					<label class="husirtrt aboutthis" tipid="listtip"><input style="vertical-align: middle;margin-right:5px;" type="radio" name="view_mode" id="" value="1" />列表形式（1/2模块宽度）</label>
					<label class="husirtrt aboutthis" tipid="alllisttip"><input style="vertical-align: middle;margin-right:5px;" type="radio" name="view_mode" id="" value="2"/>列表形式（全模块宽度）</label>
				</p>
			<?php }?>
			<p class="huretwes">
				<i class="wenicos aboutthis" tipid="cwtip"></i>
					<span class="fuhuiert">后台课件排列：</span>
					<label class="husirtrt aboutthis" tipid="alllisttip"><input style="vertical-align: middle;margin-right:5px;" type="radio" name="showmode" id="" value="2" checked="checked"/>列表模式</label>
					<label class="husirtrt aboutthis" tipid="gridtip"><input style="vertical-align: middle;margin-right:5px;" type="radio" name="showmode" id="" value="1"/>网格模式</label>
					<label class="husirtrt aboutthis" tipid="detailtip"><input style="vertical-align: middle;margin-right:5px;" type="radio" name="showmode" id="" value="3" />详情模式</label>
				</p>
			<p class="huretwes">
				<i class="wenicos aboutthis" tipid="pertip"></i>
					<span class="fuhuiert">课程权限：</span>
					<label class="husirtrt"><input style="vertical-align: middle;margin-right:5px;" type="radio" name="power" id="" value="0" checked="checked"/>老师学生都有权限</label>
					<label class="husirtrt"><input style="vertical-align: middle;margin-right:5px;" type="radio" name="power" id="" value="1" />只有老师有权限</label>
					<label class="husirtrt"><input style="vertical-align: middle;margin-right:5px;" type="radio" name="power" id="" value="2" />没有权限</label>
				</p>
			</div>
			<div class="flefle">
				...
				<span class="hnuistle">课程学分：</span>
					<input class="anyuedt intinput" name="credit" type="text" id="credit" value="10" maxlength="5"/><span class="jduetser">分</span>
				</div>
				<div class="huretwes">
				...
				<div class="huretwes">
					<div class="botmer modeprogress" style="height:70px;margin-top:0px;">
						<div class="topmer"></div>
						<p class="huisrt"><span class="huisprt">课件占比：</span><input class="husrrt intinput" name="coursecredit" id="coursecredit" value="100" type="text" maxlength="3">%</p>
						<p class="huisrt"><span class="huisprt">作业占比：</span><input class="husrrt intinput" name="examcredit" id="examcredit" value="0" type="text" maxlength="3">%</p>
					</div>
					<div class="botmer modetime" style="height:40px;margin-top:0px;margin-left:220px;width:180px;display:none">
						<div class="topmer"></div>
						<p class="huisrt"><span class="huisprt">累计时长：</span><input class="husrrt intinput" name="credittime" id="" value="" type="text">分钟</p>
					</div>
				</div>
			</div>
			<div class="flefle">
				...
				<span class="hnuistle" style="width:148px">学习顺序限制：</span>
					<a href="javascript:void(0)" class="lrbtn"></a>
