...
<div >
    ...
    <div class="xueshengguanli">
    	...
    	<div class="xueshengguanli2_top fr">						
            <ul class="fr">
                <li class="fl "><a href="<?php if($domain == 'lcyhg'){ ?>javascript:addlcyhgstu()<?php }else{ ?>javascript:addstudent()<?php } ?>">添加学生</a></li>
                <li class="fl ml20"><a href="<?php if($domain == 'lcyhg'){ ?>/aroomv2/lcyhstu/input.html<?php }else{ ?>/aroomv2/student/input.html<?php } ?>">批量导入</a></li>
				<?php if(!in_array($domain,array('zjgxedu','lcyhg')) ) { ?>
                <li class="fl ml20"><a href="/aroomv2/student/input_upgrade.html">升班导入</a></li>
				<?php } ?>
				<?php if($room['isschool']==7){?>
				<li class="fl ml20"><a href="<?=geturl('aroomv2/student/input_scb')?>">可查询账号导入</a></li>
				<?php }?>
            </ul>
        </div>
        <div class="clear"></div>
        <div class="xueshengguanli_bottom">
        	<table cellpadding="0" cellspacing="0" class="tables">
                ...
                <tr >
                    ...
                    <td width="82"><a href="<?=geturl('aroomv2/student/list_view').'?classid='.$class['classid'].'&rurl='.$rurl?>">学生管理</a></td>
                </tr>
				<?php }?>
...
function _search(){
	...
	if(searchkey == '请输入学生账号或姓名')
		searchkey = '';
	location.href = '/aroomv2/student/list_view.html?classid=0&rurl=<?=$rurl?>&q='+searchkey;
}
