    ...
    <div class="tisrwe">
        <div class="ltsire">
            ...
            <?php }else{ 
                ...
                <li class="fklisr"><a class="wursk" href="/ke.html">热门课程</a></li>
               <?php } ?>
               <li class="fklisr"><a class="wursk dusre" href="/ke/guess.html">猜你喜欢</a></li>
               <?php
                    if(!empty($sortsone)){
        ...
        <?php if(!empty($bestitems)){$i=0;?>
            ...
            <?php foreach($bestitems as $key=>$value){
                ...
                <li class="iuhni" style="margin-right:0px;">
                    ...
                    <h2 class="klejts"><a  title="<?php echo $value['iname']?>" href="/ke/<?php echo $value['itemid']?>.html"><?php echo $value['iname']?></a></h2>
