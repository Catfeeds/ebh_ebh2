    ...
    <div id="center">
		<div id="webEditor" class="font12px">
            <div id="infoPane" style="padding:32px 5px 0px">
            	...
            	<table width="70%" border="0" cellspacing="0" cellpadding="0" style="float:left;height:90px;">                  
                  ...
                  <tr style="height:45px;">
                   ...
                   <tr>
                    <td style="color:#999;padding: 13px 0;">总评：<span id="general"></span></td>
                  </tr>
                </table>
                <div class="topscore">
		          <p style="text-align: right;"><span id="sscore" style="text-decoration:underline;">0分</span></p>
		        </div>
		        <!-- <div style="float: left">总评：</div>  -->
        	</div> 
