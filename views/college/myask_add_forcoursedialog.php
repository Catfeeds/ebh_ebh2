...
<div class="biaowaim">
  ...
  <div class="txtxdaru" style="float:left;width:880px;display: inline;">

<?php $editor->xEditor('message','99%','300px'); ?>
  </div>
  
 <div class="fontfen" style="width:850px;margin-left:15px;margin-bottom:10px;margin-top:10px;height:50px;">
  ...
  <div class="fontfen" style="width:820px;margin-left:15px;margin-bottom:10px;height:50px;<?=empty($cw)?'display:none':''?>" id="cwblock">
...
<div class="trekt" id="studentdiv" style="display:none">
  ...
  <div style="float:left;margin-left:19px;width:70px;_margin-top:20px;margin-top:5px;font-weight:bold;color:#777;">相关图片：</div>
	<div style="float:left;width:750px;_margin-top:20px;">
   ...
   <div class="fontfen" id="doheight">
	<input class="tijibtn" style="margin-left:358px;width:190px;margin-top:20px;float:left;" type="button" value="提交问题" />
  </div>
</div>
</form>
</div>
