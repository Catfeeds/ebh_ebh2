...
<div class="lefrig">
	<div class="workol" id="errlisttitle" style="margin-top:0">
		<div class="work_menu" style="position:relative;">
			<ul>
				<li ><a href="<?= geturl('/college/examv2/myexamall.html').'?folderid='.$folder['folderid'] ?>"><span>待做的</span></a></li>
				<li><a href="<?= geturl('/college/examv2/myexamall.html').'?folderid='.$folder['folderid'] ?>&action=hasdo"><span>做过的</span></a></li>
				<li class="workcurrent"><a style="border-bottom: none;" href="/college/examv2/myexamerrorlist.html?folderid=<?=$folder['folderid'];?>"><span>错题本</span></a></li>
			</ul>
			
		<?php if(empty($folder)){?>
			<?php }?>
			<div class="diles dilesv2">
			<?php
				$q= empty($q)?'':$q;
				if(!empty($q)){
