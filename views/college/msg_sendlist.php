...
<?php $this->widget('sendmessage_widget', array(), array('room_type' => 'college', 'reload' => 'yes')); ?>
...
<div class="lefrig">
	...
	<div class="work_mes" style="float:none;width:1000px;padding-top:10px;">
		<ul>
			<li class="workcurrent"><a href="<?= geturl('college/msg/sendlist') ?>"><span>私信列表</span></a></li>
			<li><a href="<?= geturl('college/msg/send') ?>"><span>写私信</span></a></li>
		</ul>
	</div>
				...
				<table  width="100%" class="datatab" style="border:none;">
			  	...
			  	<tbody>
						<?php if(empty($msglist)) { ?>
			  			<tr>
							<td colspan="6" align="center" ><div class="nodata"></div></td>
						</tr>
                         <?php } else { ?>
								<?php
