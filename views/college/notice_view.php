...
<style type="text/css">
	html {background:<?=!$iszjdlr?'#f5f5f5':'none'?>;}
	.addrec{
    	width: 92px;
    	height: 30px;
...
<style type='text/css' media='print'>
	...
	<?php // var_dump($notice);?>
	<div class="waimg" style="width:960px;padding-top:<?=!$iszjdlr?'15px':'150px'?>;">
		<div class="mseng" style="width:960px;">
			...
			<div class="bottali" style="text-align:center;">
				...
				<?php if (!empty($notice['isreceipt'])) {?>
					<a href="javascript:;" class="huangbbtn printnotice" style="margin-left: 310px;">打 印</a>
	...
	<script type="text/javascript">
		//附件名字太长截取，保留后缀
		var enclosure = "<?=isset($attfile['title']) ? $attfile['title'] : '' ?>";
		...
		function addReceipt(that){
			...
			dialog({
				...
				ok:function(){
					...
					$.ajax({
						type:"post",
						url:"/college/notice/addReceipt.html",
