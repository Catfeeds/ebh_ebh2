...
<div class="waitite">
	<div class="work_menu" style="position:relative;margin-top:0">
		...
		?>
			...
			<li><a style="border-bottom: none;" href="/college/examv2/myexamerrorlist.html?folderid=<?=$folder['folderid'];?>" value="box"><span>错题本</span></a></li>
		</ul>
		<div class="TjFx">
		...
		<tr class="kettshe">
			<td style="border-top:none;">
						...
						<% }else{%>
							...
							<%}else{%>
								...
								<% }else{ %>
									...
									<a  class="bjcgs" style="right: 25px;" target="_blank" href="<%=ahref%>">查看结果</a>
									<%}else{ %>
									<a  class="bjcgs" style="" target="_blank" href="<%=ahref%>">查看结果</a>	
									<% }%>
								<%}%>
				...
				<%if(!notanswered && userAnswer.status != 0){%>
					...
					<div class="hsidts1s ml25" style="float:left;display:inline;width: 100%;"><a href="/college/examv2/errsituation/<%=eid%>.html?exampower=1" class="lasrnwe">错题情况</a><a class="lasrnwe" target="_blank" href="/college/examv2/efenxi/<%=eid%>.html">统计分析</a>
	...
	<script type="text/javascript">
		...
		function getElist(url){
			if(typeof url == "undefined") {
				url = '/college/examv2/elistAjax.html?folderid='+folderid;
			}
...
<script type="text/javascript">
	...
	$(function() {
	    ...
	    $("#ser").click(function(){
			...
			if(title == searchtext) 
	           title = "";
			var url = '/college/examv2/elistAjax.html?q='+title+'&folderid='+'<?=$folder['folderid']?>';
			getElist(url);
	    });
	});
