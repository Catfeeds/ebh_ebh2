...
<div class="workol">
	<div class="work_mes" style="width:1000px; position:relative;">
		<ul style="float:left; display:inline;">
			...
			<li class="workcurrent"><a href="<?= geturl('college/myask/myquestion') ?>"><span>我的问题</span></a></li>
		...
		<?php }?>
			...
			<div class="workdata" style="margin-top:0px;float:left; width:1000px;">
				<table  width="100%" class="datatab" style="border:none;">			  
			  	<tbody>			  
                                <?php if(empty($asks)) { ?>
			  		<tr><td colspan="5" align="center" class="nonejunrs" style="border:none;"><div class="nodata"></div></td></tr>
							<?php } else { ?>
...
initsearch("title",searchtext);
	$("#ser").click(function(){
		...
		if(title == searchtext) 
			title = "";
		var url = '<?= geturl('college/myask/myquestion') ?>' + '?q='+title;
		<?php if(!empty($folder)){
...
function delask(qid,title) {
    ...
    var successurl = '<?= geturl('college/myask/myquestion') ?>';
