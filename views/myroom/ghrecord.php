...
<div class="ter_tit"> 当前位置 > 成长记录 </div>
<div class="lsrey">
<span class="kdtgds"><?=!empty($user['realname']) ? $user['realname'] : $user['username']?></span>
<div class="hrthd">
<ul>
<li class="sktdsw">
...
$(document).on('click', ".listPage a[class!='none']", function() {
	...
	var page = tmparr[1];
	$.post('/myroom/ghrecord/getrankajax.html',{'page':page},function(data){
