...
<link href="http://static.ebanhui.com/ebh/tpl/default/css/E_ClassRoom.css" rel="stylesheet" type="text/css" />
		...
		<div class="center">
			<div class="uploadimg">
			<form name="uploadfile" id="uploadfile" enctype="multipart/form-data" method="post" action="<?=geturl('myroom/settings/avatarold')?>">
				...
				<input type="hidden" value="<?=geturl('myroom/settings/avatarold')?>" name="returnurl" />
		...
		<div class="explanation">
			...
			<div class="Sample">
				...
				<span style="margin-left:-50px;margin-top:200px;float:left;">如果无法上传头像,请尝试使用<a style="color:#49a0cb;" href="<?=geturl('myroom/settings/avatar')?>">摄像头上传模式</a></span>
		</div>
...
function saveimg(){
	...
	$.ajax({
		url:'<?=geturl('myroom/settings/avatarupdate')?>',
		type:'post',
		data:_data,
		success:function(data){
			if(data=="1"){
				...
				window.open('/myroom/settings/profile.html','_self');
			}else{
