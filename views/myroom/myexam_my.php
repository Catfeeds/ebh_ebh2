...
<div class="ter_tit">
	当前位置 > <a href="<?= geturl('myroom/myexam') ?>">我的作业</a> > 我做过的作业
	</div>
	<div class="lefrig" style="border:solid 1px #cdcdcd;background:#fff;float:left;margin-top:15px;width:786px;">
<div class="workol">
<div class="work_menu">
    <ul>
		 <li><a href="<?= geturl('myroom/myexam/all') ?>"><span>待做作业</span></a></li>
         <li class="workcurrent"><a href="<?= geturl('myroom/myexam/my')?>"><span>我做过的作业</span></a></li>
				...
				<?php if(!empty($exams)) { ?>
					<?php foreach($exams as $exam) {?>
						  <tr>
							...
							<?php } else { ?>
								<a class="previewBtn" href="http://exam.ebanhui.com/edo/<?= $exam['eid'] ?>.html" target="<?= $target?>">继续做作业</a>
							<?php } ?>
