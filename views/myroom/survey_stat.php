...
<div class="ter_tit">
	当前位置 > <a href="<?= geturl('myroom/survey/surveylist') ?>" >调查问卷</a> > 问卷统计
</div>
<div class="lefrig" style="margin-top:15px;">
	...
	<?php }?>
		...
		<div style="float:left;padding-bottom:20px" class="fontfen">
			<input style="margin-left:350px" type="button" class="tijibtn" value="返回" onclick="window.location.href='/myroom/survey/surveylist.html';">
		</div>
	</div>
