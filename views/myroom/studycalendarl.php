...
<style type="text/css">
	...
	.mmain ul li{width:108px;height: 78px;float:left;border: 1px solid #e9e9e9;border-left: none;border-bottom: none;}
	...
	.mmain .chead{border: 1px solid #ccc;border-bottom:none;border-right: solid 1px #e9e9e9;width:762px;height: 34px;line-height: 34px;margin-top:10px;;background: url('http://static.ebanhui.com/ebh/images/titlanbiao.jpg') repeat-x;}
	.mmain .chead span{text-align:center;display:block;float:left;width:108px;color: #555;}

	.quan{display:inline-block;float:right;width:7px;height:25px;position: absolute;top:59px;right: 0px;}
...
<![endif]-->
<div class="ter_tit">
当前位置 > <a href="<?=geturl('myroom/analysis')?>">学习分析表</a> >学习表
</div>
<div style="width:786px;border:solid 1px #cdcdcd;background:#fff;margin-top:15px;">
<div class="main" style="width:764px;height:573px;position:relative;">
	<div class="hmain">
		<div class="hselect" style="padding:10px;">
			...
			<div class="htab">
				<ul>
					...
					<li><a href="<?= geturl('myroom/myexam/my') ?>">作业记录</a></li>
					<li><a href="<?= geturl('myroom/myask/myanswer') ?>">答疑记录</a></li>
				</ul>
			</div>
		</div>	
	</div>
	...
	<div class="mmain">
		...
		<ul id="mainContent" style="width:780px;">
...
<input type="hidden" id="crid" value="<?= !empty($room)?$room['crid']:0?>">
