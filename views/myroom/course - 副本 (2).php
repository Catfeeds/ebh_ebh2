...
<?php $isapp = isApp();
if($isapp){	?>
<meta name="viewport" content="<?php if($course['open_chatroom'] == 1 && $course['islive'] == 0 && $folder_detail['showmode'] != 3){?>width=1310,<?php } ?>user-scalable=no" />
<?php } ?>
...
<?php if($course['open_chatroom'] == 1 && $course['islive'] == 0 && isset($folder_detail['showmode']) && $folder_detail['showmode'] != 3){
...
<script src="http://static.ebanhui.com/chatroom/js/main.js?v=20171209001"></script>
...
<div id="main-box" <?php if($course['open_chatroom'] == 1 && $course['islive'] == 0 && $folder_detail['showmode'] != 3){ ?>style="width:1310px;margin:0 auto;position: relative;" <?php }else{?>style="margin:0 auto;width:980px;" <?php }?>>

<?php if($course['open_chatroom'] == 1 && $course['islive'] == 0 && $folder_detail['showmode'] != 3){ ?>
<?php $this->display('common/chatroom'); ?>
<?php } ?>

<div class="cright" style="display: block;margin: 0 auto;width:980px;margin-bottom:20px;<?php if($course['open_chatroom'] == 1 && $course['islive'] == 0 && $folder_detail['showmode'] != 3){ ?>float:left;margin-top:0px!important; <?php }?>">
...
<?php }?>
				...
				<?php
					...
					<?php } elseif (!empty($course['cwurl']) && $type != 'flv' && $type != 'mp4' && $type != 'mov' && $type != 'avi' && $type != 'mp3'&& $type!='swf') { ?>
			...
			<?php if(($type == 'flv' || $type == 'mp3'|| $type == 'swf') && ($course['islive'] != 1 || $this->input->get('review') == 1)) { ?>
				...
				<?php if($liveinfo['review'] == 1){?>
					<?if ( $course['ism3u8'] == 1){ ?>
						<div style="width:980px;height:560px;background:white;text-align:center">
							...
							<span style="font-size:50px;width:970px;float:left;margin-top:10px">
								<a id="notebtn" class="lanbtn liaskt" name="notes" href="/myroom/mycourse/<?= $course['cwid'] ?>.html?review=1" style="font-family: 微软雅黑;font-weight:normal;margin-left:330px;height:65px;line-height:65px; margin-top:15px;margin-bottom:10px;font-size:25px;width:300px;background:#18a8f7;">进入回看</a>
							</span>
						</div>
					<?php }else{ ?>
						<div style="width:980px;height:560px;background:white;text-align:center">
	...
	$(function(){
 		$(".isPC").on("click",function(){
			var tips = top.dialog({
				...
				okValue: '立即下载',
				ok: function() {
				  location.href = "http://soft.ebh.net/ebhbrowser.exe";
				}
			});
			tips.showModal();
		});
