...
<div class="biaowaim" style="margin-top:20px;">
  ...
  <div class="txtxdaru" style="float:left;width:730px;display: inline;">
		
       <?php $editor->xEditor('message','100%','500px',$ask['message']); ?>
...
<div class="trekt" id="teacherdiv" style="display:none">
  ...
  <div style="float:left;width:680px;_margin-top:20px;">
...
<div style="background:#fff;float:left">
	 ...
	 <div style="float:left;margin-left:0px;width:610px;margin-top:10px;display:<?=empty($ask['audiosrc'])?"inline":"none"?> " id="audio_float" >
...
function editquestion() {
    $.ajax({
                url:"<?= geturl('myroom/myask/editquestion/'.$qid) ?>",
                type: "POST",
