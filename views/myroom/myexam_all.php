...
<script type="text/javascript">
 ...
 <div class="workdata" style="width:786px;">
				...
				<div style="float:left;width:700px;font-family:Microsoft YaHei;">
					...
					<span style="float:right;width:70px;">
							...
							<?php 
								...
								?>
									<a class="previewBtn" style="font-family: 宋体;" href="<?=$dourl?>" target="<?= $target?>">做作业</a>
								<?php }else{?>
									<a class="previewBtn" style="font-family: 宋体;" href="javascript:void(0)" onclick="showBuyDialog('<?=$iname?>',<?=$exam['itemid']?>)">做作业</a>
								<?php }?>
							<?php } ?>
					</span>
