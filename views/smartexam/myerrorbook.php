...
<!-- 主要内容 -->
<div class="lefrig" id="lefrig" style="background:#fff;float:left;margin-top:0px;width:1000px;">
	<a id="maodian" style="display:none;" href="#lefrig" ></a>
	<div class="workol" style="margin-top:0;" id="errlist">
		<div class="work_menu" style="position:relative;font-family:微软雅黑;">
     	 <ul>
	        <li><a target="_blank" href="http://exam.ebanhui.com/ssmartenew/<?=$crid?>.html"><span>微题</span></a></li>
	        <li><a href="<?=geturl('smartexam/smartexam/qlist')?>"><span>历史记录</span></a></li>
	        <li class="workcurrent"><a href="<?=geturl('smartexam/myerrorbook')?>"><span>错题本</span></a></li>
    	</ul>
...
<script type="text/javascript">
	...
	*/
	function page_load(pagetxt,param){
		...
		var url = "/smartexam/myerrorbook/getajaxpage.html?q="+encodeURIComponent(param.keyword);
		$("#lodding").show();
