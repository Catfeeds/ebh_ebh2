...
<a target="_blank"   class="soubtn" href="javascript:void(0)" onclick="listsearch('keywords1')">搜 索</a>
</div>
<div class="icategry">
<div class="rebiaoq">
...
<?php foreach ($labellist as $label) {?>
  <div><a target="_blank"   target='_blank' <?php if($q==$label['title']){echo "class=lanbiao";}?> href="<?= geturl('cloudlist-1-0-0--')?><?='?q='.$label['title'].'&beginprice='.$beginprice.'&endprice='.$endprice?>"><?= $label['title'] ?></a></div>
<?php }?>
</div>
</dd>
</div>
...
<div class="wtiedh">
<div>
<a target="_blank"   target='_blank' class="<?= ($beginprice==''&&$endprice=='')?'lanbiao':''?>" href="<?= geturl('cloudlist-1-0-0--')?>">不限</a>
</div>
<div>
<a target="_blank"   target='_blank' class="<?= ($beginprice=='1'&&$endprice=='100')?'lanbiao':''?>" href="<?= '/cloudlist-1-0-0-0-0.html?q='.$q.'&beginprice=1&endprice=100'?>">1-100元</a>
</div>
<div>
<a target="_blank"   target='_blank' class="<?= ($beginprice=='101'&&$endprice=='300')?'lanbiao':''?>" href="<?= '/cloudlist-1-0-0-0-0.html?q='.$q.'&beginprice=101&endprice=300'?>">101-300元</a>
</div>
<div>
  <a target="_blank"   target='_blank' class="<?= ($beginprice=='301'&&$endprice=='500')?'lanbiao':''?>" href="<?= '/cloudlist-1-0-0-0-0.html?q='.$q.'&beginprice=301&endprice=500'?>">301-500元</a>
</div>
<div>
  <a target="_blank"   target='_blank' class="<?= ($beginprice=='501'&&$endprice=='0')?'lanbiao':''?>" href="<?= '/cloudlist-1-0-0-0-0.html?q='.$q.'&beginprice=501&endprice'?>">501元以上</a>
...
<ul>
<li class="qwlean"><a target="_blank"   target='_blank' href="/cloudlist-1-0-0-.html">综合</a></li>
<li class="qwlean" style="background:url(http://static.ebanhui.com/portal/images/lieico.jpg) no-repeat 42px center;"><a target="_blank"   target='_blank' href="/cloudlist-1-2-0-.html">人气</a></li>
<li class="qwlean"><a target="_blank"   target='_blank' href="/cloudlist-1-4-0-.html">推荐</a></li>
<li><a target="_blank"   target='_blank' href="/cloudlist-1-3-0-.html">最新</a></li>
