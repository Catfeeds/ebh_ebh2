...
<p class="touxiang"><a target="_blank" href="/<?=$upcode?>/<?=$top3_1[0]['itemid']?>.html"><?=shortstr($top3_1[0]['note'],90,'……[详情]')?></a></p>
</div>
<div class="tabcon">
<ul>
<!-- <li>
...
<?php foreach ($top1_5 as $value) {?>
	<li>
		<a target="_blank" title="<?=$value['subject']?>" title="<?=$value['subject']?>" href="/<?=$upcode?>/<?=$value['itemid']?>.html" ><?=ssubstrch($value['subject'],0,40)?></a>
	</li>
<?php }?>
</ul>
</div>
...
<h2 class="quweilit">
<span class="tit540">
<a target="_blank" class="huimore" href="/<?=$upcode?>-1-0-0-<?=$catid?>-0-1.html" style="font-size:12px;">更多</a>
</span>
</h2>
<ul>
