...
<form action="<?= geturl('uploadanswercourse')?>" method="post" enctype="multipart/form-data">
		<input type="hidden" name="qid" value="<?= $qid ?>" >
		<?php $upcontrol->upcontrol('up',$type=11,$valueparam=array(),$uptype='courseware',array('button_image_url'=>'http://static.ebanhui.com/ebh/images/TestImageNoText_127x29.png','button_width'=>'127','button_text'=>'&nbsp;&nbsp;上传附件&nbsp;&nbsp;')); ?>
</form>
</div>
</body>
</html>