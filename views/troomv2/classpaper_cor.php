<?php $this->display('troomv2/page_header'); ?>
	...
	<div class="ter_tit">
		当前位置 > <a href="<?= geturl('troomv2/classpaper') ?>">在线考试</a> > 批改试卷
		</div>
...
<tbody>
		...
		<tr>
			...
			<td width="20%"><a href="<?= geturl('troomv2/classpaper/my-0-0-0-'.$cexam['classid']) ?>" class="previewBtn" title="班级试卷">班级试卷</a></td>
		</tr>
                <?php } ?>
