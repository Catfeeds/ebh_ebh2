...
<?php $i = 1;$curcourse=null; ?>
	...
	<?php if(empty($curcourse)||$curcourse['folderid']!=$course['folderid']) { ?>
		<a href="<?= geturl('troomv2/classsubject/'.$course['folderid']) ?>" >
		<h2 class="lanbiaot">
	...
	<a class="sa" target="<?= (empty($cw['cwurl']) || in_array($type,array('flv','mp4','avi'))) ? '_blank' : '' ?>" href="<?= geturl('troomv2/feedback/courses/'.$course['cwid'])?>" <?= $color ?>><?= $course['title'] ?><span>…………………………………………………………………………………………………………………………………………………………………………</span></a>
