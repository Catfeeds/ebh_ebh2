...
<div class="ter_tit">
当前位置 > <a href="#geturl(troomv2/setting/tplsetting/teachertheam)#">师资团队</a> > 添加教师</div>
<div class="lefrig">
		...
		<form action="#getsitecpurl()#" method="post" onsubmit="return submit_check()">
		    ...
		    <tr>
			  <th><label>教师头像：</label></th>
				<td colspan="2">
					<div>
					<a class='sn' id='a' style="float:left;" href='/troomv2/advertisement/$value[thumb]'>
...
<div class="ter_tit">
当前位置 > <a href="#geturl(troomv2/setting/tplsetting/teachertheam)#">师资团队</a> > 修改教师</div>
<div class="lefrig">
				<div id='atsrc' style="display: none;"></div>
