...
<div class="ter_tit">
	...
	<a href="/troomv2/classcourse/jkexcel-0-0-0-<?= $course['cwid'];?>.html" class="addbtnas previewBtn" target="_blank">导 出</a>
...
<div class="workol" style="float:left; margin-top:15px;">
	<div class="work_mes">
		<ul>
			<li class="workcurrent"><a href="<?= geturl('troomv2/classcourse/jk-0-0-0-'.$course['cwid']) ?>"><span>学习跟踪</span></a></li>
			<li><a href="<?= geturl('troomv2/classcourse/jk-0-0-1-'.$course['cwid']) ?>"><span>未学名单</span></a></li>
		</ul>
	</div>
