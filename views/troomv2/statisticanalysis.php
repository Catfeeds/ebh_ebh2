...
<div class="lefrig">
	<div class="myxuan">
		<ul>
		<li class="jiancha">
		<a href="<?= geturl('troomv2/tastulog') ?>"></a>
		</li>
		<li class="mytiku">
		<a href="<?= geturl('troomv2/statisticanalysis/classerrorbook') ?>"></a>
		</li>
		<li class="myxuex">
		<a href="<?= geturl('troomv2/statisticanalysis/scorecount') ?>"></a>
		</li>
	<!--	<li class="notessum">
		<a href="<?= geturl('troomv2/statisticanalysis/notessum') ?>"></a>
		</li>-->
		<li class="logs">
		<a href="<?= geturl('troomv2/statisticanalysis/logs') ?>"></a>
		</li>
		<li class="errors">
		<a href="<?= geturl('troomv2/statisticanalysis/errors') ?>"></a>
		</li>
		<li class="teacher">
		<a href="<?= geturl('troomv2/statisticanalysis/teach') ?>"></a>
		</li>
		</ul>
	</div>
</div>
