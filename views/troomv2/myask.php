...
<div class="workol">
	<div class="work_mes work_mesalone">
		<ul class="extendul">
			...
			<li class="workcurrent"><a href="<?= geturl('troomv2/myask/allquestion') ?>"><span>全部问题</span></a></li>
						...
						?>	               
				 		<tr>
							...
							<div style="float:left;width:870px;font-family:Microsoft YaHei;">
								...
								<?php }?>
								<!--如果是老师已经回答过的标题为蓝色-->
								<a target="_blank" href="<?= geturl('troomv2/myask/'.$avalue['qid']) ?>" style="color:<?= in_array(intval($avalue['qid']),$myanswered)?'#2696f0':'#777' ?>;font-weight:bold;">
...
$(function() {
   ...
   $("#ser").click(function(){
       ...
       if(title == searchtext) 
           title = "";
       var url = '<?= geturl('troomv2/myask/allquestion') ?>' + '?q='+title;
