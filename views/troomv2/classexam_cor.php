<?php $this->display('troomv2/page_header'); ?>
	...
	<div class="ter_tit">
		当前位置 > <a href="<?= geturl('troomv2/classexam') ?>">班级作业</a> > 批改作业
		</div>
...
<tbody>
		...
		<tr>
			...
			<td width="20%"><a href="<?= geturl('troomv2/classexam/my-0-0-0-'.$cexam['classid']) ?>" class="previewBtn" title="班级作业">班级作业</a></td>
		</tr>
                <?php } ?>
