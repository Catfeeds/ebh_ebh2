...
<div class="lefrig">
	<div class="waitite">
		<div class="work_menu" style="position:relative;margin-top:0">
			<ul>
				<li class="workcurrent"><a href="javascript:void(0)" class="title-a"><span class="jnisrso">知识点浏览</span></a></li>
			</ul>
		</div>
	<div class="hsidts" style="width:150px;">
		<?php $this->assign('currentindex',2);
		$this->display('troomv2/courselinkbar');?>
	</div>
</div>
	<div class="workdata"  style="background-color:#fff;float:left;margin:0;width: 1000px;">
