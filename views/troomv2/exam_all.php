...
<div class="ter_tit">
当前位置 > <a href="<?= geturl('troomv2/exam') ?>">在线作业</a> > 批阅作业</div>
<div class="lefrig">
<div class="workol">

<div class="work_menuss">
	<ul>
		<li><a href="<?= geturl('troomv2/exam') ?>"><span>录入的作业</span></a></li>
		<li class="workcurrent"><a href="<?= geturl('troomv2/exam/all') ?>"><span>批阅作业</span></a></li>
	</ul>
</div>
<div class="annotate">
<div class="work_search">
    <form id="searchform" action="<?= geturl('troomv2/exam/all-0-0-0-'.$menuid)?>" method="get">
	<table>
		<tr>
			<td width="250"><div class="piyue"><a style="font-weight:normal;" <?= $menuid == 0 ? 'class="pcurrent"':''?> href="<?= geturl('troomv2/exam/all')?>">待批阅</a><span>|</span><a style="font-weight:normal;" <?= $menuid == 1 ? 'class="pcurrent"':''?> href="<?= geturl('troomv2/exam/all-0-0-0-1') ?>">已批阅</a></div></td>
