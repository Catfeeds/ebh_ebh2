...
<div class="workol" >
	<div class="work_mes work_mesalone">
		<ul class="extendul">
			...
			<li class="workcurrent"><a href="<?= geturl('troomv2/myask/myfavorit') ?>"><span>我的关注</span></a></li>
			<!-- 新增 -->
...
$(function() {
   ...
   $("#ser").click(function(){
       ...
       if(title == searchtext) 
           title = "";
       var url = '<?= geturl('troomv2/myask/myfavorit') ?>' + '?q='+title;
       document.location.href = url;
   });
});
function delfavorit(aid) {
    var url = "<?= geturl('troomv2/myask/delfavorit') ?>";
    $.ajax({
	url:url,
	type:'post',
	data:{'aid':aid},
