...
<link type="text/css" href="http://static.ebanhui.com/js/dialog/css/dialog.css?v=20160913002" rel="stylesheet" />
<style>
/*关联课件 css*/
.relatefs{
	width:758px;
	...
	<div>
		...
		<fieldset class="relatefs">
			...
			<div style="margin-left: 20px;">
                    <input id="startdate" class="qisties" readonly="readonly" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',minDate:'<?=Date('Y-m-d',SYSTIME)?>'});" value="<?=empty($survey['startdate'])?date('Y-m-d H:i',SYSTIME):date('Y-m-d H:i',$survey['startdate'])?>"/>
...
function submit(){	
	...
	$.ajax({
		type:'post',
		url:'/troomv2/survey/publish.html',
