...
<div class="ter_tit">
当前位置 > <a href="/troomv2/setting/tplsetting/contact.html">联系方式</a> > 关于我们</div>
<div class="lefrig">
...
<a href="/troomv2/tplsetting/contact-0-0-0-about.html"><span>关于我们</span></a></li>
<li class="<?=$tag=='join'?'workcurrent':''?>">
<a  href="/troomv2/tplsetting/contact-0-0-0-join.html"><span>加盟合作</span></a>
</li>
<li class="<?=$tag=='copy'?'workcurrent':''?>">
<a href="/troomv2/tplsetting/contact-0-0-0-copy.html"><span>版权说明</span></a>
</li>
<li class="<?=$tag=='payment'?'workcurrent':''?>">
<a href="/troomv2/tplsetting/contact-0-0-0-payment.html"><span>付款方式</span></a>
</li>
</ul>
</div>
...
$.ajax({
url:"/troomv2/tplsetting/contactHandle.html",
type:'post',
