...
<div class="ter_tit">
当前位置 > <a href="<?= geturl('troomv2/tastulog') ?>">学生监察</a> > <a href="<?= geturl('troomv2/scalendar-0-0-0-0-0-2') ?>">学生作业</a> > <a href="<?= geturl('troomv2/scalendar/'.$memberid.'-0-0-0-2') ?>"><?= $membername ?>的作业记录</a>
<div class="diles">
