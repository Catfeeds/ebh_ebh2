...
<script type="text/javascript" src="http://static.ebanhui.com/exam/newjs/question.js<?=$v?>"></script>
...
<div id="container" class="sheet-con">
	<div class="center magAuto layoutContainer">
		<img src="http://static.ebanhui.com/exam/images/entrytest.png" class="typetestbg" />
 	   <div class="contop ">
 	   	<div class="choose"  style="position: absolute;right: 5px;top: 50px;">
