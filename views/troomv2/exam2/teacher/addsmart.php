...
<script type="text/javascript" src="http://static.ebanhui.com/ebh/js/xDialog/vendor/swfobject.js<?=$v?>"></script>
...
<script type="text/javascript"  id="xdi" src="http://static.ebanhui.com/exam/newjs/xdi/xdi.js<?=$v?>" plugs="classdialog"></script>
<!-- 引入ztree -->
...
<script type="text/javascript" src="http://static.ebanhui.com/exam/newjs/smartques.js<?=$v?>"></script>
...
<div class="rykhje">
	<div class="rtykwr">
		...
		<div class="center">
			 <a href="javascript:void(0);"  class="rtyiok active" style="margin-left: 128px;" id="examadd">布置作业</a>
		</div>
		<div class="righ">
