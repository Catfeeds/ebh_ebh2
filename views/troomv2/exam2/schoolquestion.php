...
<style>
.datatab a.addFavorite{    background: none repeat scroll 0 0 #5e96f5; color: #fff; border-radius: 2px; width: 70px; height: 25px; display: block;line-height: 25px;text-align: center;}
</style>
</head>
<body>
<script>
			...
			<div id="icategory" class="clearfix" style="border-top:none;">
				...
				<dd>
					<div class="category_cont1">
						...
						<div><a href="/troomv2/kuque/schquestion.html" class="network curr">网校题库</a></div>
