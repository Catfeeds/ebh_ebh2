...
<div class="work_menuss">
	<ul>
		...
		<li class="workcurrent"><a href="<?= geturl('troomv2/myonline/all') ?>"><span>所有直播</span></a></li>
...
<div class="lefrig" style="margin-top:10px;">
	...
	<?php foreach ($courseList as $value) {?>
		<tr style="border-bottom:1px solid #efefef;" onmouseout="this.bgColor='#ffffff'"onmouseover="this.bgColor='#f2f7ff'">
	       <td style=" height: 35px;width:138px"><a  href="/troomv2/myonline/edit.html?op=view&id=<?=$value['id']?>" style="padding:5px 10px 5px;width:52%;color:blue; cursor: pointer;font-size:12px;" title="$value['title']"><?=$value['title']?></a></td> 
		   ...
		   <td style="text-align:left;width:20%;" >
		   	<!-- <a href="/troomv2/myonline/edit.html?op=view&pos=all&id=<?=$value['id']?>" class="btnsuo" >查看</a> -->
		   <?php if($user['uid']==$value['tid']){?>
		   	<a href="javascript:" onclick="return degroup('<?=$value["id"]?>','<?=$value["title"]?>')" style="margin-left:0;margin-right:5px;" class="btnshan">删除</a>
		   		<?php if(time()<=($value['cdate'])+$value['ctime']*60){?>
		   			<a href="/troomv2/myonline/edit.html?pos=all&id=<?=$value['id']?>" class="workBtn" style="margin-right:5px;">修改</a>
		   		<?php }?>
		   <?php }?>
...
function _search(){
	...
	location.href='/troomv2/myonline/all.html?q='+q;
}
