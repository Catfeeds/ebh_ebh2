...
?>
	...
	<?php }else{?>
		当前位置 > <a href="/troomv2/statisticanalysis.html">查询统计</a> > <a href="/troomv2/statisticanalysis/teach.html"> 教师统计 </a> > 评论查看
	<?php }?>
	</div>
...
<div id="delreview" class="tanchukuang" style="display:none;height:135px;" >
    <div class="tishi" style="line-height:0px;margin-bottom:0px;height:60px;padding-top: 80px;"><span>你确定要屏蔽该评论吗？</span></div>
</div>
<!--取消评论-->
<div id="cancelshielddiv" class="tanchukuang" style="display:none;height:135px;">
    <div class="tishi" style="line-height:0px;margin-bottom:0px;height:60px;padding-top: 80px;"><span>你确定要取消该屏蔽的评论吗？</span></div>
</div>
</body>
<script>
//屏蔽评论
function shielddiv(cwid,logid){
	...
	function shield(cwid,logid){
		...
		$.ajax({
			...
			type:'post',
			url:'<?= geturl('troomv2/review/shield')?>',
			dataType:'json',
...
function canceldiv(cwid,logid){
	...
	function cancel(cwid,logid){
		...
		$.ajax({
			...
			type:'post',
			url:'<?= geturl('troomv2/review/cancleshield')?>',
			dataType:'json',
			data:{'cwid':cwid,'logid':logid},
			success:function(data){
				if(data != undefined && data.status != undefined && data.status == 1) {
