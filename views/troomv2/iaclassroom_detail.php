			...
			<div class="fotwaim" id="div2">
				<ul id="ialog">
					...
					<li class="newzuo ">
						...
						<div style="text-align:center;float:left;width:182px;"><?=date("Y-m-d H:i:s",$answer['lastpost'])?></div>
					</li>
					<?php }?>
				</ul>
			</div>
...
<script type="text/javascript">
	...
	function getLogs(){
		$.ajax({
			'type':'POST',
			'url':'/troomv2/iaclassroom/getDetailAjax.html',
			'data':{'icid':<?=$ia['icid']?>},
			'dataType':'json',
