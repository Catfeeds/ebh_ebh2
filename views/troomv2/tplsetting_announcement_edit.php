...
<div class="ter_tit">
当前位置 > <a href="<?= geturl('troomv2/tplsetting')?>">公告管理</a> > 修改公告</div>
<div class="lefrig">
<?php $this->display('troomv2/tplsetting_menu'); ?>
				<div class="annotate" style="color:#888888; margin-left: 20px;">在此页面中，您可以修改公告内容。</div>
				<br/> 
		<form id="upform">
...
$(function(){
		...
		$("#savebtn").click(function(){
			if(submit_check('message')) {
				var url="<?= geturl('troomv2/tplsetting/announcement/edit')?>";
				$.ajax({
					url:url,
					type: "POST",
					...
					success:function(data){
						if(data == 'success') {
							$.showmessage({
								...
								title:'修改公告',
								callback :function(){
									 document.location.href = "<?= geturl('troomv2/tplsetting') ?>";
								}
							});
						} else {
							$.showmessage({
