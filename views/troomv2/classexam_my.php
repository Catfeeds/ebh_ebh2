...
<div class="ter_tit">
		当前位置 > <a href="<?= geturl('troomv2/classexam') ?>">班级作业</a> > <a href="<?= geturl('troomv2/classexam/cor') ?>">批改作业</a> > <?= $myclass['classname'] ?>
</div>
				...
				<td>
					...
					<div style="float:left;width:238px;">
						...
						<?php if($exam['status'] == 0) { ?>
							...
							<?php }?>
						<?php } else { ?>
						<a class="previewBtn" href="<?= geturl('troomv2/classexam/all-0-0-0-'.$myclass['classid'].'-'.$exam['eid']) ?>" >作业批阅</a>
						<?php } ?>
