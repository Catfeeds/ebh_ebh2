...
<div class="flopadt">
<a class="jiabgbtn hongbtn" onclick="location.href='/troomv2/tplsetting/advertisement/add.html'">添加广告</a>
...
<?php foreach($ads as $ad){?>
 ...
 <td width="54%"><a href="/troomv2/tplsetting/advertisement_edit.html?itemid=<?=$ad["itemid"]?>" title="<?=$ad['subject']?>"><?=shortstr($ad['subject'],20)?></a></td>

<td width="25%"><a href="<?=$ad['itemurl']?>" target="_blank"><?=$ad['itemurl']?></a></td>
 <td width="16%">
<a class="workBtn" onclick="location.href='/troomv2/tplsetting/advertisement_edit.html?itemid=<?=$ad["itemid"]?>'">修改</a>
...
$.confirm("您确定要删除【" + subject + "】广告吗？",function(){
      $.ajax({
    url:"/troomv2/tplsetting/advertisement_del.html",
    type:'post',
