...
<link type="text/css" href="http://static.ebanhui.com/ebh/tpl/default/css/myind.css" rel="stylesheet" />
	...
	<div class="ter_tit"> 当前位置 > <a href="<?= geturl('troomv2/mysetting') ?>">我的首页</a> > 我的通知 </div>
	<div class="lefrig">
			...
			<tbody>
				...
				<?php if(!empty($notices)) { ?>
					...
					<tr <?= ($notice['dateline'] + 604800) > SYSTIME? 'class="lately"':'' ?>>
						...
						<td width="8%"><a class="chaqianbtn" nid="<?= $notice['noticeid'] ?>" href="<?= geturl('troomv2/notice/'.$notice['noticeid']) ?>" target="_blank">浏 览</a></td>
					</tr>
					<?php } ?>
