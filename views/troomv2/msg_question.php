...
<div class="workol">
	<div class="work_mes">
		<ul>
			...
			<li class="workcurrent"><a href="<?= geturl('troomv2/msg/question') ?>"><span>新问题</span></a></li>
...
" title="<?= empty($value['realname'])?$value['username']:$value['realname'] ?>" src="<?=$face?>" /></div>
													<div style="float:left;width:905px;font-family:Microsoft YaHei;">
                                                        ...
                                                        ?>
                                                        	...
                                                        	<a style="color:#2696f0;font-weight:bold;text-decoration:underline;" href="<?= geturl('troomv2/myask/'.$value['sourceid']) ?>" target="_blank" ><?= $value['message'] ?></a>
                                                        </p>
