...
<div class="ter_tit">
当前位置 > <a href="<?= geturl('troomv2/myask') ?>">学生答疑</a> > 所属问题</div>
<div class="lefrig">
<div class="workol">
	<div class="work_menuss">
		<ul>
			<li  class="workcurrent"><a href="<?= geturl('troomv2/myask/allteachquestion') ?>"><span>所属问题</span></a></li>
			<li><a href="<?= geturl('troomv2/myask') ?>"><span>全部问题</span></a></li>
...
<div class="annotate">
	<div class="tiezi_search" style="height:30px;">
			...
			<a class="questionbutton" style="color:#fff;margin-left: 10px;" href="<?= geturl('troomv2/myask/addquestion') ?>">提&nbsp;&nbsp;问</a>
			</div>
	</div>
			<div class="workdata">
			  	...
			  	<tbody>
			  		...
			  		<tr><td colspan="5" align="center">目前没有问题记录</td></tr>
				 		...
				 		<tr>
					    	...
					    	<td width="22%"><a class="previewBtn" href="<?= geturl('troomv2/myask/'.$avalue['qid']) ?>">查看问题</a><a class="quxiaobutton" style="color: #8e8d8d;text-decoration: none;margin-left: 5px;" onclick="delask(<?= $avalue['qid'] ?>,'<?= $avalue['title'] ?>');" href="javascript:;">删除</a></td>
                                                <?php } else { ?>
							<td width="22%"><a class="previewBtn" href="<?= geturl('troomv2/myask/'.$avalue['qid']) ?>">查看详情</a><a class="quxiaobutton" style="color: #8e8d8d;text-decoration: none;margin-left: 5px;" href="javascript:delask(<?= $avalue['qid'] ?>,'<?= $avalue['title'] ?>');">删除</a></td>
...
initsearch("title",searchtext);
   $("#ser").click(function(){
       ...
       if(title == searchtext) 
           title = "";
       var url = '<?= geturl('troomv2/myask/allteachquestion') ?>' + '?q='+title;
