...
<script type="text/javascript" src="http://static.ebanhui.com/js/jquery-migrate-1.2.1.min.js"></script>
	...
	<div class="ter_tit">
		当前位置 > <a href="<?= geturl('troomv2/classsubject') ?>">班级课程</a> > <a href="<?= geturl('troomv2/classsubject/'.$folder['folderid']) ?>"><?= $folder['foldername'] ?></a> > 批量上传
		</div>
...
<script type="text/javascript">
    function course_submit() {
        ...
        if(1) {
            $.ajax({
                url:"<?= geturl('troomv2/classcourse/addmulti') ?>",
                type: "POST",
