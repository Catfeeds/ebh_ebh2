...
<div class="ter_tit">
	当前位置 > <a href="<?= geturl('troomv2/tools')  ?>">应用工具</a> > <a href="<?= geturl('troomv2/slock')  ?>">学生锁屏</a> > 添加锁屏
</div>
<div class="lefrig" style="background:#fff;float:left;margin-top:15px;">
<div class="work_mes">
	<ul>
		<li><a href="<?= geturl('troomv2/slock')  ?>"><span>我的锁屏</span></a></li>
		<li class="workcurrent"><a href="<?= geturl('troomv2/slock/add')?>"><span>添加锁屏</span></a></li>
...
<script>
	...
	function beforesubmit(){
		...
		$.post("/troomv2/slock/add.html",{param:$("#formdata").serialize()},function(res){
				if(res.status == 0){
					$.showmessage({
						message:res.msg,
						callback :function(){
