...
<div class="ter_tit">
当前位置 > <a href="/troomv2/setting/tplsetting/information.html">资讯管理</a> > 发布资讯</div>
<div class="lefrig">
<?php $this->display('troomv2/tplsetting_menu'); ?>
<div id='atsrc' style="display: none;"></div>
<div class="annotate" style="color:#888888; margin-left: 20px;">在此页面中，您可以填写资讯标题，选择资讯状态，编写资讯摘要、资讯内容。</div>
<br/> 
<div class="work_menu" style="margin-top: -22px;">
<ul>
<li ><a href="/troomv2/tplsetting/information.html"><span>资讯列表</span></a></li>
<li class="workcurrent"><a href="/troomv2/tplsetting/information/add.html"><span>发布资讯</span></a></li>
</ul>
</div>
...
$("#savebtn").click(function(){
      if(submit_check()) {
        var url="<?= geturl('troomv2/tplsetting/information/edit')?>";
        $.ajax({
          url:url,
          type: "POST",
          ...
          success:function(data){
            if(data == 'success') {
              $.showmessage({
                ...
                title:'编辑资讯',
                callback :function(){
                   document.location.href = "<?= geturl('troomv2/tplsetting/information') ?>";
                }
              });
            } else {
              $.showmessage({
