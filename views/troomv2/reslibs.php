	...
	<?php if($roominfo['grade'] == 1){ ?>
		<div class="fotwaim" id="div1">
			...
			<?php foreach($primarySchool as $primary){ ?>
				<li class="kemule">
					<a href="<?= geturl('troomv2/reslibs/reslist-0-0-0-1-'.$primary['gid'])?>" style="cursor:pointer;display: block; height: 120px;width: 148px;text-decoration:none;">
	...
	<?php }elseif($roominfo['grade'] == 7){ ?>
		<div class="fotwaim" id="div2">
			...
			<?php foreach($middleSchool as $middle){ ?>
				<li class="kemule">
					<a href="<?= geturl('troomv2/reslibs/reslist-0-0-0-7-'.$middle['gid'])?>" style="cursor:pointer;display: block; height: 120px;width: 148px;text-decoration:none;">
	...
	<?php }elseif($roominfo['grade'] == 10){ ?>
		<div class="fotwaim" id="div3">
			...
			<?php foreach($highSchool as $high){ ?>
				<li class="kemule">
					<a href="<?= geturl('troomv2/reslibs/reslist-0-0-0-10-'.$high['gid'])?>" style="cursor:pointer;display: block; height: 120px;width: 148px;text-decoration:none;">
