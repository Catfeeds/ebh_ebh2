...
?>
<div class="ter_tit">
当前位置 > <a href="<?=geturl('troomv2/setting/avatarold')?>">教室头像</a> > 系统头像
</div>
<div class="lefrig" style="border:solid 1px #cdcdcd;background:#fff;float:left;margin-top:15px;width:786px;">
<div class="workol">
<div class="work_menu">
	<ul>
		<li><a href="<?=geturl('troomv2/setting/avatarold')?>"><span>自定义头像</span></a></li>
		<li class="workcurrent"><a href="<?=geturl('troomv2/setting/roomlogo')?>"><span>系统头像</span></a></li>
	</ul>
		</div>
