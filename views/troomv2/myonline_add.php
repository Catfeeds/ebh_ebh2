...
<div class="work_mes">
	<ul>
		<li><a href="<?= geturl('troomv2/myonline')  ?>"><span>我的直播</span></a></li>
		<!-- <li><a href="<?= geturl('troomv2/myonline/all')  ?>"><span>所有直播</span></a></li> -->
		<li class="workcurrent"><a href="<?= geturl('troomv2/myonline/add')?>"><span>添加直播</span></a></li>
...
<script>
	...
	function beforesubmit(){
		...
		$.post("/troomv2/myonline/add.html",{param:$("#formdata").serialize()},function(message){
				if(message=="1"){
					$.showmessage({
						message:'添加成功！',
						callback :function(){
