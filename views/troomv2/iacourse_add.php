...
<link type="text/css" href="http://static.ebanhui.com/ebh/tpl/default/css/survey.css?v=20161121001" rel="stylesheet" />
...
<script type="text/javascript" src="http://static.ebanhui.com/ebh/js/iacourseadd.js?v=005"></script>
	...
	<div class="leersd clearfix" style="margin-bottom:70px;">
		<div class="survey_main fl">
			...
			<div class="survey_title" style="position:relative">
				<div class="h4-bg T_edit p_title" id="survey_title_0">单击此处添加标题</div>
			...
			<div id="survey_content">
				<img style="margin-left:70px;" src="http://static.ebanhui.com/ebh/tpl/selcur/images/mosrets.jpg" id="addimg" />
			</div>
		</div>
    ...
    <?php }else{?>
    	<?php if(!empty($folders)){?>
    		<?php foreach ($folders as $folder) {?>
    			<?php if(isset($folder['foldername'])) {?>
