...
<script type="text/javascript" src="http://static.ebanhui.com/ebh/js/easyui/locale/easyui-lang-zh_CN.js"></script>
					...
					<div class="ter_tit">
						当前位置 > <a href="<?= geturl('troomv2/student') ?>">学员管理</a> > 开通统计
					</div>
					<div class="lefrig">
...
<div class="work_menuss">
			<ul>
				...
				<li class="workcurrent"><a href="<?= geturl('troomv2/student/opencount') ?>"><span>开通统计</span></a></li>
			</ul>
</div>
...
function serc(){
    ...
    var url = '<?= geturl('troomv2/student/opencount')?>'+"?"+param;
