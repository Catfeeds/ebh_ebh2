...
.noke span {
	...
	<div class="ter_tit">
		当前位置 > <a href="<?= geturl('troomv2/classsubject') ?>" ?>课程管理</a> > 听课反馈
...
<div class="kejian">
	...
	<li class="danke">
	<div class="showimg"><a href="<?= geturl('troomv2/feedback/'.$subject['folderid']) ?>" title="<?= $subject['foldername'] ?>"><img src="<?= empty($subject['img']) ? 'http://static.ebanhui.com/ebh/images/nopic.jpg' : $subject['img'] ?>" width="114" height="159" border="0" /></a></div>
	<span class="spne"><a href="<?= geturl('troomv2/feedback/'.$subject['folderid']) ?>" style="text-decoration: none;" title="<?= $subject['foldername'] ?>"><?= ssubstrch($subject['foldername'],0,20) ?>(<?= $subject['coursewarenum'] ?>)</a></span>
	</li>
        <?php } ?>
