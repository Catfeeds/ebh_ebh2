...
<div class="tiezitool"><a class="jiabgbtn hongbtn" style="width:110px;" href="<?= geturl('troomv2/tplsetting/teacherteam/add')?>" >添加团队成员</a></div>
		...
		<?php foreach($teachers as $teacher){?>
				  <tr>
					...
					<td width="15%"><div class="teac_manage">
						<a class="workBtn" href="/troomv2/tplsetting/teacherteam/edit.html?itemid=<?=$teacher['itemid']?>" >修改</a>
...
function degroup(itemid,subject) {
	$.confirm("您确定要删除【" + subject + "】教师吗？",function(){
		$.ajax({
				url:"/troomv2/tplsetting/teacherteam/del.html",
				type:'post',
...
function serc(){
	var subject = $("#subject").val();
		...
		subject = subject.replace(/\#/g,"");
		subject = subject.replace(/\%/g,"");
	var url = '/troomv2/tplsetting/teacherteam-0-0-0.html?q='+subject;
