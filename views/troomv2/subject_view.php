...
$(function(){
	$('#searchbutton').click(function(){
		var href = '<?= geturl('troomv2/subject/'.$folder['folderid']) ?>';
...
<link type="text/css" href="http://static.ebanhui.com/ebh/tpl/default/css/E_ClassRoom.css" rel="stylesheet" />
	<div class="ter_tit">
		当前位置 > <a href="<?= geturl('troomv2/subject') ?>">课程列表</a> > <?= $folder['foldername'] ?>
		</div>
	<div class="lefrig">
...
<div class="tiezitool">
	<a class="chuanbgbtn hongbtn marrig" href="<?= geturl('troomv2/course/add-0-0-0-'.$folder['folderid'])?>">上传课件</a>
...
<div class="workol">
	<div class="work_menuss">
		<ul>
<li class="workcurrent"><a href="<?= geturl('troomv2/subject/'.$folder['folderid'])?>"><span>所有课件</span></a></li>
</ul>
</div>
</div>
				  ...
				  <tr>
					...
					<?php $arr = explode('.',$course['cwurl']);
							$type = $arr[count($arr)-1]; ?>
					    		...
					    		<img alt="此课件包含附件"  src="http://static.ebanhui.com/ebh/tpl/default/images/fujian.gif"/>(<?= $course['attachmentnum'] ?>)
                                        <?php } ?>
				    	<a target="<?= (empty($course['cwurl']) || $type == 'flv') ? '_blank' : '' ?>"  href="<?= (empty($course['cwurl']) || $type == 'flv') ? geturl('troomv2/course/'.$course['cwid']) : geturl('troomv2/classcourse/'.$course['cwid']) ?>"><?= $course['title'] ?></a>
				    </td>
				    ...
				    <td width="255px">
				    	...
				    	<div class="fujian">
                                                        ...
                                                        <?php if(!empty($course['attachmentnum'])) { ?>
					 			<a class="previewBtn" onclick="location.href='<?= geturl('troomv2/attachlist-0-0-0-'.$course['cwid']) ?>'">附件管理</a>
                                                        <?php } else { ?>
                                
					 			<a class="previewBtn" href="<?= geturl('troomv2/course/upattach-0-0-0-'.$course['cwid'])?>">上传附件</a>
					 		<?php } ?>
							...
							<input type="button" class="replyBtn" style="cursor:pointer;vertical-align: middle;font-weight:100;" onclick="location.href='<?= geturl('troomv2/course/edit-0-0-0-'.$course['cwid'])?>'" value="修改" />
	...
	<script type="text/javascript">
		function delkj(cwid,title){
			$.confirm("确认删除课件[ " + title +" ]吗？",function(){
				var url = "/troomv2/course/del.html";
                                $.ajax({
                                    type: "POST",
                                    url: url,
                                    data: {'cwid':cwid},
