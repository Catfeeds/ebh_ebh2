...
<div class="workol">
	<div class="work_mes work_mesalone">
		<ul class="extendul">
			...
			<li class="workcurrent"><a href="<?= geturl('troomv2/myask/hot') ?>"><span>热门</span></a></li>
			...
			<div class="workdata" style="margin-top:0px;float:left;">
				<table  width="100%" class="datatab" style="border:none;">
			  	...
			  	<tbody>
						<?php if(empty($asks)) { ?>
			  			<tr>
							<td colspan="6" align="center" style="border-top:none;"><div style="text-align:center;"><div class="nodata"></div></div></td>
						</tr>
                         <?php } else { ?>
...
$(function() {
   ...
   $("#ser").click(function(){
       ...
       if(title == searchtext) 
           title = "";
       var url = '<?= geturl('troomv2/myask/hot') ?>' + '?q='+title;
