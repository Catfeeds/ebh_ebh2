...
<div class="ter_tit">
	当前位置 &gt; <a href="<?=geturl('troomv2/examapply')?>">认证管理</a> &gt; 已通过
        <div class="diles fr">
    ...
    <div class="workol">
        <div class="work_mes">
            <ul class="extendul">
                ...
                <li class="workcurrent"><a href="<?=geturl('troomv2/examapply/passapply')?>"><span>已通过</span></a></li>
...
function _search(){
	...
	if(searchkey == '请输入学生姓名或登录帐号')
		searchkey = '';
	location.href = '<?=geturl('troomv2/examapply/passapply')?>?q='+searchkey;
}
