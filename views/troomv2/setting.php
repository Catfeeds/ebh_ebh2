...
<div class="lefrig" style="margin-top:10px;">
	<div class="tertiop">
		...
		<a href="<?= geturl('troomv2/setting/avatarold') ?>" class="potton">
		<img src="<?= $cface?>" style="width:100px;height:100px;"/>
		</a>
		<a href="<?= geturl('troomv2/setting/avatarold') ?>" class="gaitu">修改头像</a>
...
function addlabel() {
	...
	if (labels != "" && labels != "多个标签词之间请用空格分开")
	{
		...
		for(var i = 0; i < labelarr.length; i ++) {
			...
			listr += '<a href="javascript:void(0)" onclick="removelabel(this)" title="删除标签" class="labeldel"><img src="http://static.ebanhui.com/ebh/tpl/default/images/transparent.gif" /></a>';
			listr += '</li>';
