...
<div class="ter_tit">
当前位置 > <a href="<?= geturl('troomv2/tools')  ?>">应用工具</a> > <a href="<?= geturl('troomv2/slock')  ?>">学生锁屏</a> > 我的锁屏
...
<div class="work_mes">
	<ul>
		<li class="workcurrent"><a href="<?= geturl('troomv2/slock')  ?>"><span>我的锁屏</span></a></li>
		...
		<tbody>
		    ...
		    <?php }else{?>
				...
				<tr onmouseout="this.bgColor='#ffffff'" onmouseover="this.bgColor='#f2f7ff'"  bgcolor="#ffffff">
		      	<td style="height: 35px;"><a href="/troomv2/slock/<?=$slock['lockid']?>.html" title="<?=$slock['title']?>" style="padding:5px 10px 5px;width:25%;color:blue; cursor: pointer;font-size:12px;"><?=shortstr($slock['title'],28,'')?></a></td> 
			    ...
			    <td style="text-align:left;width:20%;">
			    	...
			    	<a href="/troomv2/slock/edit.html?lockid=<?=$slock['lockid']?>" class="workBtn">修改</a>
			    	<?php }?>
			    	<a class="workBtn" style="color:#fff;text-decoration: none;" href="/troomv2/slock/<?=$slock['lockid']?>.html">查看</a>
			   	</td>
				</tr>
