...
<div class="ter_tit">
	当前位置 &gt; <a href="<?=geturl('troomv2/examapply')?>">认证管理</a> &gt; <a href="<?=geturl('troomv2/examapply')?>">成绩统计</a> &gt; 已通过未发证
        <div class="diles fr">
...
<div class="lefrig">
    <div class="workol">
        <div class="work_mes">
            ...
            <ul class="extendul">
                <li class="workcurrent"><a href="/troomv2/examapply/result/<?=$eid?>.html"><span>已通过未发证</span></a></li>
...
function _search(){
	...
	if(searchkey == '请输入学生姓名或登录帐号')
		searchkey = '';
	location.href = '<?=geturl('troomv2/examapply/result/'.$eid)?>?q='+searchkey;
}
function _examexcel(){
	var startdate = $('#startdate').val();
	var enddate = $('#enddate').val();
	location.href = '/troomv2/examapply/examexcel/<?=$eid?>.html?type=1&startdate='+startdate+'&enddate='+enddate;
}
$(function(){
	//批量选择
	...
	$("#doaward").click(function(){
		...
		button.add({
			...
			callback:function(){
				...
				$.post('/troomv2/examapply/batchaward.html',{ids:idarr.join(",")},function(data){
