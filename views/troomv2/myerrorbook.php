...
<div class="ter_tit">
当前位置 > <a href="<?= geturl('troomv2/tastulog') ?>">学生监察</a> > <a href="<?= geturl('troomv2/scalendar-0-0-0-0-0-4') ?>">查看错题集</a> > <a href="<?= geturl('troomv2/scalendar/'.$memberid.'-0-0-0-4') ?>"><?= $membername ?>的错题集</a>
<div class="diles">
