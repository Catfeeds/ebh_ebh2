...
<br/>      
<form id="upform"  action="/troomv2/tplsetting/advertisement_add.html" method="post" onsubmit="return submit_check()">
...
$("#savebtn").click(function(){
      if(submit_check()) {
        var url="<?= geturl('troomv2/tplsetting/advertisement/add')?>";
        $.ajax({
          url:url,
          type: "POST",
