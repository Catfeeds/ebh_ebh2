...
<!-- 12.02.2016 -->
<meta content="width=1000, user-scalable=yes,target-densitydpi=300;" name="viewport"/>
	...
	<div class="clay_topfixed_inner">
		<div class="ctoolbar">
			...
			<div class="chead" style="width:1000px;">
				...
				<a href="/" class="homepage-1"><?=($room_type==1) ? "平台首页":"网校首页"?></a>
				<div class="csubnav">
				| <a  href="<?= geturl('troomv2') ?>"><?=$room['crname']?></a>
				<?php if($room['uid'] == $user['uid'] && ($room['isschool'] == 3 || $room['isschool'] == 6 || $room['isschool'] == 7) ) { ?>
				|<a href="http://<?= empty($room['fulldomain']) ? $room['domain'].'.ebh.net' : $room['fulldomain']?>/aroomv3.html" name="">管理平台</a>
				<?php } if (!empty($adminRole)) { ?>
                |<a href="/aroomv3.html">管理平台</a>
                <?php }?>
