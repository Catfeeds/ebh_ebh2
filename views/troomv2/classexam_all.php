...
<!--            <li><a href="#">单题批阅</a></li>-->
    ...
    <div class="lishnrt">
		<a href="/troomv2/classexam/all-0-0-0-<?php echo $myclass['classid']?>-<?php echo $myexam['eid']?>.html" class="hietse <?php echo empty($status)?'xhusre':''?>">全部</a>
		<a href='/troomv2/classexam/all-0-0-0-<?php echo $myclass['classid']?>-<?php echo $myexam['eid']?>.html?status=1'class="hietse <?php echo $status == 1?'xhusre':''?>">已交作业</a>
		<a href='/troomv2/classexam/all-0-0-0-<?php echo $myclass['classid']?>-<?php echo $myexam['eid']?>.html?status=2' class="hietse <?php echo $status==2?'xhusre':''?>">未交作业</a>
...
<script type="text/javascript">
	...
	$(".completetime").click(function(){	
		if(order=="1") {
			location.href='<?= geturl('troomv2/classexam/all-0-2-0-'.$myclass['classid'].'-'.$myexam['eid']) ?>?status=<?=$status?>';
		}else{
			location.href='<?= geturl('troomv2/classexam/all-0-1-0-'.$myclass['classid'].'-'.$myexam['eid']) ?>?status=<?=$status?>';
		}
	});
	$(".totalscore").click(function(){
		if(order=="3") {
			location.href='<?= geturl('troomv2/classexam/all-0-4-0-'.$myclass['classid'].'-'.$myexam['eid']) ?>?status=<?=$status?>';
		}else{
			location.href='<?= geturl('troomv2/classexam/all-0-3-0-'.$myclass['classid'].'-'.$myexam['eid']) ?>?status=<?=$status?>';
		}
	});
	<?php }?>
