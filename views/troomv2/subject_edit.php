...
<div class="ter_tit">
	当前位置 > <a href="<?=geturl('troomv2/subject')?>">课程管理</a> > 编辑课程
	</div>
...
<form id="foldervalue" action="<?=geturl('troomv2/subject/edit')?>" method="post">
...
<div class="cqshangc">
	...
	<span class="pxxuanx">课程名称：</span>
	  <input name="foldername" id="foldername" type="text" onblur="checkfoldername()" class="inpxuanx" style="width: 327px;background: url(http://static.ebanhui.com/ebh/tpl/2012/images/inp_bg01.png) no-repeat;" value="<?=$coursedetail['foldername']?>" maxlength="20"/>
	  <p id="foldernamespan" style="margin:5px 0px 10px 80px; color:#999;">请输入课程名称如：高一语文上册</p>
	  <span class="pxxuanx">课程排序：</span>
	  <input type="text" class="inpxuanx" onblur="checkdisplayorder()" style="width: 116px;background: url(http://static.ebanhui.com/ebh/tpl/2012/images/inp_bg02.png) no-repeat;" maxlength="10" id="displayorder" name="displayorder" value="<?=$coursedetail['displayorder']?>" />
	  	  <p id="displayorderspan" style="margin:5px 0px 10px 80px; color:#999;">序列号越小越靠前</p>
	<span class="pxxuanx">课程介绍：</span>
	  <textarea name="summary" style="min-height: 100px;height:100px;" onblur="checksummary()" id="summary" class="w388 txt"><?=$coursedetail['summary']?></textarea>
...
<div class="tab_box" style="<?=$picstyle?>">
