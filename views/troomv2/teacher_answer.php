...
?>
	...
	<?php }else{?>
		当前位置 > <a href="/troomv2/statisticanalysis.html">查询统计</a> > <a href="/troomv2/statisticanalysis/teach.html"> 教师统计 </a> > 答疑查看
	<?php }?>
	</div>
        ...
        <tr >
            ...
            <td width="127">
				<?php if(empty($answer['shield'])){?>
					<a href="<?=geturl('troomv2/myask/'.$answer['qid']).'?rurl='.$this->uri->path.'&rrurl='.$rurl?>">
					查看详情</a>
