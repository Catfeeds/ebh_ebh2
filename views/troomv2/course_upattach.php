...
<div class="ter_tit">
当前位置 > <a href="<?= geturl('troomv2/subject') ?>">课程列表</a> > <a href="<?= geturl('troomv2/subject/'.$course['folderid'])?>"><?= $course['foldername'] ?></a> > 上传附件
</div>
<div class="lefrig">
...
//		}
		...
		function submitform() {
			var url="<?= geturl('troomv2/course/upattach') ?>";
			$.ajax({
				url:url,
				type:"post",
				dataType:"json",
