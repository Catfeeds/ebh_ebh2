...
<div class="ter_tit">
当前位置 > <a href="<?= geturl('troomv2/tastulog') ?>">学生监察</a> > <a href="<?= geturl('troomv2/scalendar-0-0-0-0-0-1') ?>">听课笔记</a> > <a href="<?= geturl('troomv2/scalendar/'.$memberid.'-0-0-0-1') ?>"><?= $membername ?>的听课笔记</a>
<div class="diles">
...
function ser(){
	var url = '<?= geturl('troomv2/mynotes') ?>';
    var uid = $("#uid").val();
