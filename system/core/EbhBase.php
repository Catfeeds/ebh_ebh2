...
class EbhBase {
    ...
    private static $_coreClasses = array('CWebApplication' => 'core/CWebApplication.php',
        ...
        'ApiControl' => 'core/ApiControl.php',
		'CPortalModel' => 'core/CPortalModel.php',
		'CFreeResourceModel' => 'core/CFreeResourceModel.php',
        'CShopModel' => 'core/CShopModel.php',
        'ARoomV3Controller' => 'core/ARoomV3Control.php',
        'SnsBaseController' => 'core/SnsControl.php',
    );
	/**
	*错误处理方法，收集所有的错误信息并记录
	*/
...
set_error_handler(array('EbhBase','ebh_error_handler'));
