...
class PaymentRequest extends TrxRequest
{
	...
	/** 支付类型：银联在线跨行支付方式*/
	const PAY_TYPE_UCBP='6';//增加2013 11 18
...
//	private $iMerchantRemarks = '';
	 ...
	 protected  function checkRequest()
	{
		...
		//王辰增加 2009 4 23
		if($this->iPaymentType!=self::PAY_TYPE_ABC && $this->iPaymentType != self::PAY_TYPE_INT && $this->iPaymentType != self::PAY_TYPE_CREDIT && $this->iPaymentType != self::PAY_TYPE_ALL && $this->iPaymentType!=self::PAY_TYPE_CBP&& $this->iPaymentType!=self::PAY_TYPE_UCBP)
